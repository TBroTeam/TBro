...
/**
 * Base class that represents a row from the 'study_assay' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseStudyAssay extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\StudyAssayPeer';
    ...
    /**
     * The value for the study_assay_id field.
     * @var        int
     */
    protected $study_assay_id;
    ...
    /**
     * Get the [study_assay_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [study_assay_id] column.
     *
     * @param int $v new value
     * @return StudyAssay The current object (for fluent API support)
     */
    public function setStudyAssayId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->study_assay_id !== $v) {
            $this->study_assay_id = $v;
            $this->modifiedColumns[] = StudyAssayPeer::STUDY_ASSAY_ID;
        }
    ...
    public function setStudyId($v)
    {
        ...
        if ($this->study_id !== $v) {
            $this->study_id = $v;
            $this->modifiedColumns[] = StudyAssayPeer::STUDY_ID;
        }
    ...
    public function setAssayId($v)
    {
        ...
        if ($this->assay_id !== $v) {
            $this->assay_id = $v;
            $this->modifiedColumns[] = StudyAssayPeer::ASSAY_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->study_assay_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = StudyAssayPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating StudyAssay object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = StudyAssayPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = StudyAssayQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StudyAssayPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = StudyAssayPeer::STUDY_ASSAY_ID;
        if (null !== $this->study_assay_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . StudyAssayPeer::STUDY_ASSAY_ID . ')');
        }
        if (null === $this->study_assay_id) {
            try {
                $stmt = $con->query("SELECT nextval('study_assay_study_assay_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->study_assay_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(StudyAssayPeer::STUDY_ASSAY_ID)) {
            $modifiedColumns[':p' . $index++]  = '"study_assay_id"';
        }
        if ($this->isColumnModified(StudyAssayPeer::STUDY_ID)) {
            $modifiedColumns[':p' . $index++]  = '"study_id"';
        }
        if ($this->isColumnModified(StudyAssayPeer::ASSAY_ID)) {
            $modifiedColumns[':p' . $index++]  = '"assay_id"';
        }

        $sql = sprintf(
            'INSERT INTO "study_assay" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"study_assay_id"':
                        $stmt->bindValue($identifier, $this->study_assay_id, PDO::PARAM_INT);
                        break;
                    case '"study_id"':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = StudyAssayPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = StudyAssayPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StudyAssay'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StudyAssay'][$this->getPrimaryKey()] = true;
        $keys = StudyAssayPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getStudyAssayId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setStudyAssayId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StudyAssayPeer::STUDY_ASSAY_ID)) $criteria->add(StudyAssayPeer::STUDY_ASSAY_ID, $this->study_assay_id);
        if ($this->isColumnModified(StudyAssayPeer::STUDY_ID)) $criteria->add(StudyAssayPeer::STUDY_ID, $this->study_id);
        if ($this->isColumnModified(StudyAssayPeer::ASSAY_ID)) $criteria->add(StudyAssayPeer::ASSAY_ID, $this->assay_id);
    ...
    {
        $criteria = new Criteria(StudyAssayPeer::DATABASE_NAME);
        $criteria->add(StudyAssayPeer::STUDY_ASSAY_ID, $this->study_assay_id);
    ...
    /**
     * Generic method to set the primary key (study_assay_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getStudyAssayId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of StudyAssay (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setStudyAssayId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return StudyAssay Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return StudyAssayPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new StudyAssayPeer();
        }
    ...
    public function getAssay(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAssay === null && ($this->assay_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAssay->addStudyAssays($this);
             */
        }
    ...
    public function getStudy(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aStudy === null && ($this->study_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aStudy->addStudyAssays($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(StudyAssayPeer::DEFAULT_STRING_FORMAT);
    }
