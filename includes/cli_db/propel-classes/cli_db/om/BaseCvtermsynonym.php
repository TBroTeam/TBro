...
/**
 * Base class that represents a row from the 'cvtermsynonym' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseCvtermsynonym extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\CvtermsynonymPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CvtermsynonymPeer
     */
    ...
    /**
     * The value for the cvtermsynonym_id field.
     * @var        int
     */
    protected $cvtermsynonym_id;
    ...
    /**
     * Get the [cvtermsynonym_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [cvtermsynonym_id] column.
     *
     * @param int $v new value
     * @return Cvtermsynonym The current object (for fluent API support)
     */
    public function setCvtermsynonymId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->cvtermsynonym_id !== $v) {
            $this->cvtermsynonym_id = $v;
            $this->modifiedColumns[] = CvtermsynonymPeer::CVTERMSYNONYM_ID;
        }
    ...
    public function setCvtermId($v)
    {
        ...
        if ($this->cvterm_id !== $v) {
            $this->cvterm_id = $v;
            $this->modifiedColumns[] = CvtermsynonymPeer::CVTERM_ID;
        }
    ...
    public function setSynonym($v)
    {
        ...
        if ($this->synonym !== $v) {
            $this->synonym = $v;
            $this->modifiedColumns[] = CvtermsynonymPeer::SYNONYM;
        }
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[] = CvtermsynonymPeer::TYPE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->cvtermsynonym_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->cvterm_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->synonym = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 4; // 4 = CvtermsynonymPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Cvtermsynonym object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CvtermsynonymPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CvtermsynonymQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CvtermsynonymPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = CvtermsynonymPeer::CVTERMSYNONYM_ID;
        if (null !== $this->cvtermsynonym_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CvtermsynonymPeer::CVTERMSYNONYM_ID . ')');
        }
        if (null === $this->cvtermsynonym_id) {
            try {
                $stmt = $con->query("SELECT nextval('cvtermsynonym_cvtermsynonym_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->cvtermsynonym_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(CvtermsynonymPeer::CVTERMSYNONYM_ID)) {
            $modifiedColumns[':p' . $index++]  = '"cvtermsynonym_id"';
        }
        if ($this->isColumnModified(CvtermsynonymPeer::CVTERM_ID)) {
            $modifiedColumns[':p' . $index++]  = '"cvterm_id"';
        }
        if ($this->isColumnModified(CvtermsynonymPeer::SYNONYM)) {
            $modifiedColumns[':p' . $index++]  = '"synonym"';
        }
        if ($this->isColumnModified(CvtermsynonymPeer::TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"type_id"';
        }

        $sql = sprintf(
            'INSERT INTO "cvtermsynonym" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"cvtermsynonym_id"':
                        $stmt->bindValue($identifier, $this->cvtermsynonym_id, PDO::PARAM_INT);
                        break;
                    case '"cvterm_id"':
                        $stmt->bindValue($identifier, $this->cvterm_id, PDO::PARAM_INT);
                        break;
                    case '"synonym"':
                        $stmt->bindValue($identifier, $this->synonym, PDO::PARAM_STR);
                        break;
                    case '"type_id"':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CvtermsynonymPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CvtermsynonymPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getCvtermsynonymId();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['Cvtermsynonym'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Cvtermsynonym'][$this->getPrimaryKey()] = true;
        $keys = CvtermsynonymPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCvtermsynonymId(),
            $keys[1] => $this->getCvtermId(),
            $keys[2] => $this->getSynonym(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setCvtermsynonymId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setCvtermId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setSynonym($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CvtermsynonymPeer::CVTERMSYNONYM_ID)) $criteria->add(CvtermsynonymPeer::CVTERMSYNONYM_ID, $this->cvtermsynonym_id);
        if ($this->isColumnModified(CvtermsynonymPeer::CVTERM_ID)) $criteria->add(CvtermsynonymPeer::CVTERM_ID, $this->cvterm_id);
        if ($this->isColumnModified(CvtermsynonymPeer::SYNONYM)) $criteria->add(CvtermsynonymPeer::SYNONYM, $this->synonym);
        if ($this->isColumnModified(CvtermsynonymPeer::TYPE_ID)) $criteria->add(CvtermsynonymPeer::TYPE_ID, $this->type_id);
    ...
    {
        $criteria = new Criteria(CvtermsynonymPeer::DATABASE_NAME);
        $criteria->add(CvtermsynonymPeer::CVTERMSYNONYM_ID, $this->cvtermsynonym_id);
    ...
    /**
     * Generic method to set the primary key (cvtermsynonym_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getCvtermsynonymId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Cvtermsynonym (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCvtermsynonymId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Cvtermsynonym Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CvtermsynonymPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CvtermsynonymPeer();
        }
    ...
    public function setCvtermRelatedByCvtermId(Cvterm $v = null)
    {
        ...
        if ($v !== null) {
            $v->addCvtermsynonymRelatedByCvtermId($this);
        }
    ...
    public function getCvtermRelatedByCvtermId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCvtermRelatedByCvtermId === null && ($this->cvterm_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCvtermRelatedByCvtermId->addCvtermsynonymsRelatedByCvtermId($this);
             */
        }
    ...
    public function setCvtermRelatedByTypeId(Cvterm $v = null)
    {
        ...
        // If this object has already been added to the Cvterm object, it will not be re-added.
        if ($v !== null) {
            $v->addCvtermsynonymRelatedByTypeId($this);
        }
    ...
    public function getCvtermRelatedByTypeId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCvtermRelatedByTypeId === null && ($this->type_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCvtermRelatedByTypeId->addCvtermsynonymsRelatedByTypeId($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CvtermsynonymPeer::DEFAULT_STRING_FORMAT);
    }
