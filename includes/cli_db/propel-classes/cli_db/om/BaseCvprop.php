...
/**
 * Base class that represents a row from the 'cvprop' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseCvprop extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\CvpropPeer';
    ...
    /**
     * The value for the cvprop_id field.
     * @var        int
     */
    protected $cvprop_id;
    ...
    /**
     * Initializes internal state of BaseCvprop object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [cvprop_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [cvprop_id] column.
     *
     * @param int $v new value
     * @return Cvprop The current object (for fluent API support)
     */
    public function setCvpropId($v)
    {
        ...
        if ($this->cvprop_id !== $v) {
            $this->cvprop_id = $v;
            $this->modifiedColumns[] = CvpropPeer::CVPROP_ID;
        }
    ...
    public function setCvId($v)
    {
        ...
        if ($this->cv_id !== $v) {
            $this->cv_id = $v;
            $this->modifiedColumns[] = CvpropPeer::CV_ID;
        }
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[] = CvpropPeer::TYPE_ID;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = CvpropPeer::VALUE;
        }
    ...
    public function setRank($v)
    {
        ...
        if ($this->rank !== $v) {
            $this->rank = $v;
            $this->modifiedColumns[] = CvpropPeer::RANK;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->cvprop_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 5; // 5 = CvpropPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Cvprop object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CvpropPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CvpropQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CvpropPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CvpropPeer::CVPROP_ID)) {
            $modifiedColumns[':p' . $index++]  = '"cvprop_id"';
        }
        if ($this->isColumnModified(CvpropPeer::CV_ID)) {
            $modifiedColumns[':p' . $index++]  = '"cv_id"';
        }
        if ($this->isColumnModified(CvpropPeer::TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"type_id"';
        }
        if ($this->isColumnModified(CvpropPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '"value"';
        }
        if ($this->isColumnModified(CvpropPeer::RANK)) {
            $modifiedColumns[':p' . $index++]  = '"rank"';
        }

        $sql = sprintf(
            'INSERT INTO "cvprop" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"cvprop_id"':
                        $stmt->bindValue($identifier, $this->cvprop_id, PDO::PARAM_INT);
                        break;
                    case '"cv_id"':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CvpropPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CvpropPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Cvprop'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Cvprop'][$this->getPrimaryKey()] = true;
        $keys = CvpropPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getCvpropId(),
            $keys[1] => $this->getCvId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setCvpropId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CvpropPeer::CVPROP_ID)) $criteria->add(CvpropPeer::CVPROP_ID, $this->cvprop_id);
        if ($this->isColumnModified(CvpropPeer::CV_ID)) $criteria->add(CvpropPeer::CV_ID, $this->cv_id);
        if ($this->isColumnModified(CvpropPeer::TYPE_ID)) $criteria->add(CvpropPeer::TYPE_ID, $this->type_id);
        if ($this->isColumnModified(CvpropPeer::VALUE)) $criteria->add(CvpropPeer::VALUE, $this->value);
        if ($this->isColumnModified(CvpropPeer::RANK)) $criteria->add(CvpropPeer::RANK, $this->rank);
    ...
    {
        $criteria = new Criteria(CvpropPeer::DATABASE_NAME);
        $criteria->add(CvpropPeer::CVPROP_ID, $this->cvprop_id);
    ...
    /**
     * Generic method to set the primary key (cvprop_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of Cvprop (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCvpropId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Cvprop Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CvpropPeer::DEFAULT_STRING_FORMAT);
    }
