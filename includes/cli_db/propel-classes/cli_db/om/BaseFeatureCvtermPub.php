...
/**
 * Base class that represents a row from the 'feature_cvterm_pub' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseFeatureCvtermPub extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\FeatureCvtermPubPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FeatureCvtermPubPeer
     */
    ...
    /**
     * The value for the feature_cvterm_pub_id field.
     * @var        int
     */
    protected $feature_cvterm_pub_id;
    ...
    /**
     * Get the [feature_cvterm_pub_id] column value.
     *
     * @return int
     */
    public function getFeatureCvtermPubId()
    {
        return $this->feature_cvterm_pub_id;
    }
    ...
    /**
     * Set the value of [feature_cvterm_pub_id] column.
     *
     * @param int $v new value
     * @return FeatureCvtermPub The current object (for fluent API support)
     */
    public function setFeatureCvtermPubId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->feature_cvterm_pub_id !== $v) {
            $this->feature_cvterm_pub_id = $v;
            $this->modifiedColumns[] = FeatureCvtermPubPeer::FEATURE_CVTERM_PUB_ID;
        }


        return $this;
    } // setFeatureCvtermPubId()
    ...
    public function setFeatureCvtermId($v)
    {
        ...
        if ($this->feature_cvterm_id !== $v) {
            ...
            $this->modifiedColumns[] = FeatureCvtermPubPeer::FEATURE_CVTERM_ID;
        }
    ...
    public function setPubId($v)
    {
        ...
        if ($this->pub_id !== $v) {
            $this->pub_id = $v;
            $this->modifiedColumns[] = FeatureCvtermPubPeer::PUB_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->feature_cvterm_pub_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = FeatureCvtermPubPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FeatureCvtermPub object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FeatureCvtermPubPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FeatureCvtermPubQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FeatureCvtermPubPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = FeatureCvtermPubPeer::FEATURE_CVTERM_PUB_ID;
        if (null !== $this->feature_cvterm_pub_id) {
        ...
        if (null === $this->feature_cvterm_pub_id) {
            try {
                $stmt = $con->query("SELECT nextval('feature_cvterm_pub_feature_cvterm_pub_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->feature_cvterm_pub_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(FeatureCvtermPubPeer::FEATURE_CVTERM_PUB_ID)) {
            $modifiedColumns[':p' . $index++]  = '"feature_cvterm_pub_id"';
        }
        if ($this->isColumnModified(FeatureCvtermPubPeer::FEATURE_CVTERM_ID)) {
            $modifiedColumns[':p' . $index++]  = '"feature_cvterm_id"';
        }
        if ($this->isColumnModified(FeatureCvtermPubPeer::PUB_ID)) {
            $modifiedColumns[':p' . $index++]  = '"pub_id"';
        }

        $sql = sprintf(
            'INSERT INTO "feature_cvterm_pub" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"feature_cvterm_pub_id"':
                        $stmt->bindValue($identifier, $this->feature_cvterm_pub_id, PDO::PARAM_INT);
                        break;
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FeatureCvtermPubPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FeatureCvtermPubPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getFeatureCvtermPubId();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['FeatureCvtermPub'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FeatureCvtermPub'][$this->getPrimaryKey()] = true;
        $keys = FeatureCvtermPubPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getFeatureCvtermPubId(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setFeatureCvtermPubId($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setFeatureCvtermPubId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FeatureCvtermPubPeer::FEATURE_CVTERM_PUB_ID)) $criteria->add(FeatureCvtermPubPeer::FEATURE_CVTERM_PUB_ID, $this->feature_cvterm_pub_id);
        if ($this->isColumnModified(FeatureCvtermPubPeer::FEATURE_CVTERM_ID)) $criteria->add(FeatureCvtermPubPeer::FEATURE_CVTERM_ID, $this->feature_cvterm_id);
        if ($this->isColumnModified(FeatureCvtermPubPeer::PUB_ID)) $criteria->add(FeatureCvtermPubPeer::PUB_ID, $this->pub_id);
    ...
    {
        $criteria = new Criteria(FeatureCvtermPubPeer::DATABASE_NAME);
        $criteria->add(FeatureCvtermPubPeer::FEATURE_CVTERM_PUB_ID, $this->feature_cvterm_pub_id);
    ...
    /**
     * Generic method to set the primary key (feature_cvterm_pub_id column).
     *
    ...
    {
        $this->setFeatureCvtermPubId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getFeatureCvtermPubId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of FeatureCvtermPub (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setFeatureCvtermPubId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FeatureCvtermPub Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FeatureCvtermPubPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FeatureCvtermPubPeer();
        }
    ...
    public function getFeatureCvterm(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFeatureCvterm === null && ($this->feature_cvterm_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFeatureCvterm->addFeatureCvtermPubs($this);
             */
        }
    ...
    public function getPub(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPub === null && ($this->pub_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPub->addFeatureCvtermPubs($this);
             */
        }
    ...
    {
        $this->feature_cvterm_pub_id = null;
    ...
    {
        return (string) $this->exportTo(FeatureCvtermPubPeer::DEFAULT_STRING_FORMAT);
    }
