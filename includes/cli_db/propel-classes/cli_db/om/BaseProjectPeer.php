...
use cli_db\propel\map\ProjectTableMap;
...
abstract class BaseProjectPeer
{
    ...
    const OM_CLASS = 'cli_db\\propel\\Project';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('ProjectId', 'Name', 'Description', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('projectId', 'name', 'description', ),
        BasePeer::TYPE_COLNAME => array (ProjectPeer::PROJECT_ID, ProjectPeer::NAME, ProjectPeer::DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PROJECT_ID', 'NAME', 'DESCRIPTION', ),
        BasePeer::TYPE_FIELDNAME => array ('project_id', 'name', 'description', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('ProjectId' => 0, 'Name' => 1, 'Description' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('projectId' => 0, 'name' => 1, 'description' => 2, ),
        BasePeer::TYPE_COLNAME => array (ProjectPeer::PROJECT_ID => 0, ProjectPeer::NAME => 1, ProjectPeer::DESCRIPTION => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('PROJECT_ID' => 0, 'NAME' => 1, 'DESCRIPTION' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('project_id' => 0, 'name' => 1, 'description' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function clearRelatedInstancePool()
    {
        ...
        // Invalidate objects in ProjectPubPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        ProjectPubPeer::clearInstancePool();
        // Invalidate objects in ProjectRelationshipPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
