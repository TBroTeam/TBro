 ...
 *
 * @method OrganismQuery leftJoinOrganismDbxref($relationAlias = null) Adds a LEFT JOIN clause to the query using the OrganismDbxref relation
 * @method OrganismQuery rightJoinOrganismDbxref($relationAlias = null) Adds a RIGHT JOIN clause to the query using the OrganismDbxref relation
 * @method OrganismQuery innerJoinOrganismDbxref($relationAlias = null) Adds a INNER JOIN clause to the query using the OrganismDbxref relation
 *
 * @method OrganismQuery leftJoinOrganismprop($relationAlias = null) Adds a LEFT JOIN clause to the query using the Organismprop relation
 * @method OrganismQuery rightJoinOrganismprop($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Organismprop relation
 * @method OrganismQuery innerJoinOrganismprop($relationAlias = null) Adds a INNER JOIN clause to the query using the Organismprop relation
 *
...
abstract class BaseOrganismQuery extends ModelCriteria
{
    ...
    public function filterByOrganismDbxref($organismDbxref, $comparison = null)
    {
        if ($organismDbxref instanceof OrganismDbxref) {
            return $this
                ->addUsingAlias(OrganismPeer::ORGANISM_ID, $organismDbxref->getOrganismId(), $comparison);
    ...
    public function filterByOrganismprop($organismprop, $comparison = null)
    {
        if ($organismprop instanceof Organismprop) {
            return $this
                ->addUsingAlias(OrganismPeer::ORGANISM_ID, $organismprop->getOrganismId(), $comparison);
