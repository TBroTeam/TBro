...
/**
 * Base class that represents a row from the 'feature_pub' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseFeaturePub extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\FeaturePubPeer';
     ...
     * @return FeaturePub The current object (for fluent API support)
     */
    public function setFeaturePubId($v)
    {
        ...
        if ($this->feature_pub_id !== $v) {
            ...
            $this->modifiedColumns[] = FeaturePubPeer::FEATURE_PUB_ID;
        }
    ...
    public function setFeatureId($v)
    {
        ...
        if ($this->feature_id !== $v) {
            $this->feature_id = $v;
            $this->modifiedColumns[] = FeaturePubPeer::FEATURE_ID;
        }
    ...
    public function setPubId($v)
    {
        ...
        if ($this->pub_id !== $v) {
            $this->pub_id = $v;
            $this->modifiedColumns[] = FeaturePubPeer::PUB_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->feature_pub_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = FeaturePubPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FeaturePub object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FeaturePubPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FeaturePubQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FeaturePubPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = FeaturePubPeer::FEATURE_PUB_ID;
        if (null !== $this->feature_pub_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . FeaturePubPeer::FEATURE_PUB_ID . ')');
        }
        if (null === $this->feature_pub_id) {
            try {
                $stmt = $con->query("SELECT nextval('feature_pub_feature_pub_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->feature_pub_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(FeaturePubPeer::FEATURE_PUB_ID)) {
            $modifiedColumns[':p' . $index++]  = '"feature_pub_id"';
        }
        if ($this->isColumnModified(FeaturePubPeer::FEATURE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"feature_id"';
        }
        if ($this->isColumnModified(FeaturePubPeer::PUB_ID)) {
            $modifiedColumns[':p' . $index++]  = '"pub_id"';
        }

        $sql = sprintf(
            'INSERT INTO "feature_pub" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FeaturePubPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FeaturePubPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FeaturePub'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FeaturePub'][$this->getPrimaryKey()] = true;
        $keys = FeaturePubPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getFeaturePubId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setFeaturePubId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FeaturePubPeer::FEATURE_PUB_ID)) $criteria->add(FeaturePubPeer::FEATURE_PUB_ID, $this->feature_pub_id);
        if ($this->isColumnModified(FeaturePubPeer::FEATURE_ID)) $criteria->add(FeaturePubPeer::FEATURE_ID, $this->feature_id);
        if ($this->isColumnModified(FeaturePubPeer::PUB_ID)) $criteria->add(FeaturePubPeer::PUB_ID, $this->pub_id);
    ...
    {
        $criteria = new Criteria(FeaturePubPeer::DATABASE_NAME);
        $criteria->add(FeaturePubPeer::FEATURE_PUB_ID, $this->feature_pub_id);
    ...
    /**
     * Generic method to set the primary key (feature_pub_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getFeaturePubId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of FeaturePub (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setFeaturePubId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FeaturePub Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FeaturePubPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FeaturePubPeer();
        }
    ...
    public function getFeature(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFeature === null && ($this->feature_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFeature->addFeaturePubs($this);
             */
        }
     ...
     * If this FeaturePub is new, it will return
    ...
    public function setFeaturePubprops(PropelCollection $featurePubprops, PropelPDO $con = null)
    {
        ...
        foreach ($featurePubpropsToDelete as $featurePubpropRemoved) {
            $featurePubpropRemoved->setFeaturePub(null);
        }
     ...
     * Otherwise if this FeaturePub is new, it will return
     * an empty collection; or if this FeaturePub has previously
     * been saved, it will retrieve related FeaturePubprops from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in FeaturePub.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|FeaturePubprop[] List of FeaturePubprop objects
     */
    public function getFeaturePubpropsJoinCvterm($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = FeaturePubpropQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(FeaturePubPeer::DEFAULT_STRING_FORMAT);
    }
