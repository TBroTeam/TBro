...
use cli_db\propel\map\ChannelTableMap;
...
abstract class BaseChannelPeer
{
    ...
    const OM_CLASS = 'cli_db\\propel\\Channel';
     ...
     * e.g. ChannelPeer::$fieldNames[ChannelPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('ChannelId', 'Name', 'Definition', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('channelId', 'name', 'definition', ),
        BasePeer::TYPE_COLNAME => array (ChannelPeer::CHANNEL_ID, ChannelPeer::NAME, ChannelPeer::DEFINITION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CHANNEL_ID', 'NAME', 'DEFINITION', ),
        BasePeer::TYPE_FIELDNAME => array ('channel_id', 'name', 'definition', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. ChannelPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('ChannelId' => 0, 'Name' => 1, 'Definition' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('channelId' => 0, 'name' => 1, 'definition' => 2, ),
        BasePeer::TYPE_COLNAME => array (ChannelPeer::CHANNEL_ID => 0, ChannelPeer::NAME => 1, ChannelPeer::DEFINITION => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CHANNEL_ID' => 0, 'NAME' => 1, 'DEFINITION' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('channel_id' => 0, 'name' => 1, 'definition' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        $toNames = ChannelPeer::getFieldNames($toType);
        $key = isset(ChannelPeer::$fieldKeys[$fromType][$name]) ? ChannelPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ChannelPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ChannelPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ChannelPeer::$fieldNames[$type];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ChannelPeer::CHANNEL_ID);
            $criteria->addSelectColumn(ChannelPeer::NAME);
            $criteria->addSelectColumn(ChannelPeer::DEFINITION);
        } else {
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ChannelPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(ChannelPeer::DATABASE_NAME);
     ...
     *
     * @param      Channel $obj A Channel object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = (string) $obj->getChannelId();
            } // if key === null
            ChannelPeer::$instances[$key] = $obj;
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(ChannelPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ChannelPeer::$instances[$key])) {
                return ChannelPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (ChannelPeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        ChannelPeer::$instances = array();
    }
    ...
    {
        $key = ChannelPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = ChannelPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + ChannelPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = ChannelPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        return Propel::getDatabaseMap(ChannelPeer::DATABASE_NAME)->getTable(ChannelPeer::TABLE_NAME);
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ChannelPeer::CHANNEL_ID) && $criteria->keyContainsValue(ChannelPeer::CHANNEL_ID) ) {
    ...
    /**
     * Performs an UPDATE on the database, given a Channel or Criteria object.
     *
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ChannelPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(ChannelPeer::CHANNEL_ID);
            $value = $criteria->remove(ChannelPeer::CHANNEL_ID);
            if ($value) {
                $selectCriteria->add(ChannelPeer::CHANNEL_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(ChannelPeer::TABLE_NAME);
            }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(ChannelPeer::TABLE_NAME, $con, ChannelPeer::DATABASE_NAME);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ChannelPeer::CHANNEL_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ChannelPeer::DATABASE_NAME);
        $criteria->add(ChannelPeer::CHANNEL_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ChannelPeer::DATABASE_NAME);
            $criteria->add(ChannelPeer::CHANNEL_ID, $pks, Criteria::IN);
