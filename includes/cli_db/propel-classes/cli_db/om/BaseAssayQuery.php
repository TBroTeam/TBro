 ...
 *
 * @method AssayQuery leftJoinArraydesign($relationAlias = null) Adds a LEFT JOIN clause to the query using the Arraydesign relation
 * @method AssayQuery rightJoinArraydesign($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Arraydesign relation
 * @method AssayQuery innerJoinArraydesign($relationAlias = null) Adds a INNER JOIN clause to the query using the Arraydesign relation
 *
 * @method AssayQuery leftJoinDbxref($relationAlias = null) Adds a LEFT JOIN clause to the query using the Dbxref relation
 * @method AssayQuery rightJoinDbxref($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Dbxref relation
 * @method AssayQuery innerJoinDbxref($relationAlias = null) Adds a INNER JOIN clause to the query using the Dbxref relation
 *
 ...
 *
 * @method AssayQuery leftJoinAssayProject($relationAlias = null) Adds a LEFT JOIN clause to the query using the AssayProject relation
 * @method AssayQuery rightJoinAssayProject($relationAlias = null) Adds a RIGHT JOIN clause to the query using the AssayProject relation
 * @method AssayQuery innerJoinAssayProject($relationAlias = null) Adds a INNER JOIN clause to the query using the AssayProject relation
 *
 * @method AssayQuery leftJoinAssayprop($relationAlias = null) Adds a LEFT JOIN clause to the query using the Assayprop relation
 * @method AssayQuery rightJoinAssayprop($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Assayprop relation
 * @method AssayQuery innerJoinAssayprop($relationAlias = null) Adds a INNER JOIN clause to the query using the Assayprop relation
 *
 * @method AssayQuery leftJoinControl($relationAlias = null) Adds a LEFT JOIN clause to the query using the Control relation
 * @method AssayQuery rightJoinControl($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Control relation
 * @method AssayQuery innerJoinControl($relationAlias = null) Adds a INNER JOIN clause to the query using the Control relation
 *
 * @method AssayQuery leftJoinStudyAssay($relationAlias = null) Adds a LEFT JOIN clause to the query using the StudyAssay relation
 * @method AssayQuery rightJoinStudyAssay($relationAlias = null) Adds a RIGHT JOIN clause to the query using the StudyAssay relation
 * @method AssayQuery innerJoinStudyAssay($relationAlias = null) Adds a INNER JOIN clause to the query using the StudyAssay relation
 *
 * @method AssayQuery leftJoinStudyfactorvalue($relationAlias = null) Adds a LEFT JOIN clause to the query using the Studyfactorvalue relation
 * @method AssayQuery rightJoinStudyfactorvalue($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Studyfactorvalue relation
 * @method AssayQuery innerJoinStudyfactorvalue($relationAlias = null) Adds a INNER JOIN clause to the query using the Studyfactorvalue relation
 *
...
abstract class BaseAssayQuery extends ModelCriteria
{
    ...
    public function filterByArraydesign($arraydesign, $comparison = null)
    {
        if ($arraydesign instanceof Arraydesign) {
            return $this
                ->addUsingAlias(AssayPeer::ARRAYDESIGN_ID, $arraydesign->getArraydesignId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AssayPeer::ARRAYDESIGN_ID, $arraydesign->toKeyValue('PrimaryKey', 'ArraydesignId'), $comparison);
        } else {
    ...
    public function filterByDbxref($dbxref, $comparison = null)
    {
        if ($dbxref instanceof Dbxref) {
            return $this
                ->addUsingAlias(AssayPeer::DBXREF_ID, $dbxref->getDbxrefId(), $comparison);
            ...
            return $this
                ->addUsingAlias(AssayPeer::DBXREF_ID, $dbxref->toKeyValue('PrimaryKey', 'DbxrefId'), $comparison);
        } else {
    ...
    public function filterByAssayProject($assayProject, $comparison = null)
    {
        if ($assayProject instanceof AssayProject) {
            return $this
                ->addUsingAlias(AssayPeer::ASSAY_ID, $assayProject->getAssayId(), $comparison);
    ...
    public function filterByAssayprop($assayprop, $comparison = null)
    {
        if ($assayprop instanceof Assayprop) {
            return $this
                ->addUsingAlias(AssayPeer::ASSAY_ID, $assayprop->getAssayId(), $comparison);
    ...
    public function filterByControl($control, $comparison = null)
    {
        if ($control instanceof Control) {
            return $this
                ->addUsingAlias(AssayPeer::ASSAY_ID, $control->getAssayId(), $comparison);
    ...
    public function filterByStudyAssay($studyAssay, $comparison = null)
    {
        if ($studyAssay instanceof StudyAssay) {
            return $this
                ->addUsingAlias(AssayPeer::ASSAY_ID, $studyAssay->getAssayId(), $comparison);
    ...
    public function filterByStudyfactorvalue($studyfactorvalue, $comparison = null)
    {
        if ($studyfactorvalue instanceof Studyfactorvalue) {
            return $this
                ->addUsingAlias(AssayPeer::ASSAY_ID, $studyfactorvalue->getAssayId(), $comparison);
