...
abstract class BaseContactPeer
{
    ...
    const OM_CLASS = 'cli_db\\propel\\Contact';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('ContactId', 'TypeId', 'Name', 'Description', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('contactId', 'typeId', 'name', 'description', ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::CONTACT_ID, ContactPeer::TYPE_ID, ContactPeer::NAME, ContactPeer::DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CONTACT_ID', 'TYPE_ID', 'NAME', 'DESCRIPTION', ),
        BasePeer::TYPE_FIELDNAME => array ('contact_id', 'type_id', 'name', 'description', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('ContactId' => 0, 'TypeId' => 1, 'Name' => 2, 'Description' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('contactId' => 0, 'typeId' => 1, 'name' => 2, 'description' => 3, ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::CONTACT_ID => 0, ContactPeer::TYPE_ID => 1, ContactPeer::NAME => 2, ContactPeer::DESCRIPTION => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('CONTACT_ID' => 0, 'TYPE_ID' => 1, 'NAME' => 2, 'DESCRIPTION' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('contact_id' => 0, 'type_id' => 1, 'name' => 2, 'description' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ContactPeer::CONTACT_ID);
            $criteria->addSelectColumn(ContactPeer::TYPE_ID);
            $criteria->addSelectColumn(ContactPeer::NAME);
            $criteria->addSelectColumn(ContactPeer::DESCRIPTION);
        } else {
    ...
    public static function doCountJoinCvterm(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ContactPeer::TYPE_ID, CvtermPeer::CVTERM_ID, $join_behavior);
    ...
    /**
     * Selects a collection of Contact objects pre-filled with their Cvterm objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCvterm(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Contact) to $obj2 (Cvterm)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Contact) to the collection in $obj2 (Cvterm)
                $obj2->addContact($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ContactPeer::CONTACT_ID) && $criteria->keyContainsValue(ContactPeer::CONTACT_ID) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ContactPeer::CONTACT_ID);
            $value = $criteria->remove(ContactPeer::CONTACT_ID);
            if ($value) {
                $selectCriteria->add(ContactPeer::CONTACT_ID, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ContactPeer::CONTACT_ID, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ContactPeer::DATABASE_NAME);
        $criteria->add(ContactPeer::CONTACT_ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ContactPeer::DATABASE_NAME);
            $criteria->add(ContactPeer::CONTACT_ID, $pks, Criteria::IN);
