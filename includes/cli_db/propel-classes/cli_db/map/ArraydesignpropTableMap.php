...
/**
 * This class defines the structure of the 'arraydesignprop' table.
 *
 *
 *
 ...
 */
class ArraydesignpropTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cli_db.map.ArraydesignpropTableMap';
    ...
    {
        // attributes
        $this->setName('arraydesignprop');
        $this->setPhpName('Arraydesignprop');
        $this->setClassname('cli_db\\propel\\Arraydesignprop');
        $this->setPackage('cli_db');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('arraydesignprop_arraydesignprop_id_seq');
        // columns
        $this->addPrimaryKey('arraydesignprop_id', 'ArraydesignpropId', 'INTEGER', true, null, null);
