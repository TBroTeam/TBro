...
class PubTableMap extends TableMap
{
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('FeatureRelationshipPub', 'cli_db\\propel\\FeatureRelationshipPub', RelationMap::ONE_TO_MANY, array('pub_id' => 'pub_id', ), 'CASCADE', null, 'FeatureRelationshipPubs');
        $this->addRelation('FeatureRelationshippropPub', 'cli_db\\propel\\FeatureRelationshippropPub', RelationMap::ONE_TO_MANY, array('pub_id' => 'pub_id', ), 'CASCADE', null, 'FeatureRelationshippropPubs');
        ...
        $this->addRelation('FeaturelocPub', 'cli_db\\propel\\FeaturelocPub', RelationMap::ONE_TO_MANY, array('pub_id' => 'pub_id', ), 'CASCADE', null, 'FeaturelocPubs');
        $this->addRelation('FeaturepropPub', 'cli_db\\propel\\FeaturepropPub', RelationMap::ONE_TO_MANY, array('pub_id' => 'pub_id', ), 'CASCADE', null, 'FeaturepropPubs');
        $this->addRelation('ProjectPub', 'cli_db\\propel\\ProjectPub', RelationMap::ONE_TO_MANY, array('pub_id' => 'pub_id', ), 'CASCADE', null, 'ProjectPubs');
        $this->addRelation('Protocol', 'cli_db\\propel\\Protocol', RelationMap::ONE_TO_MANY, array('pub_id' => 'pub_id', ), 'SET NULL', null, 'Protocols');
        ...
        $this->addRelation('Study', 'cli_db\\propel\\Study', RelationMap::ONE_TO_MANY, array('pub_id' => 'pub_id', ), 'SET NULL', null, 'Studys');
    } // buildRelations()
