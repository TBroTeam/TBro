...
/**
 * This class defines the structure of the 'cvterm_relationship' table.
 *
 *
 *
 ...
 */
class CvtermRelationshipTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cli_db.map.CvtermRelationshipTableMap';
    ...
    {
        // attributes
        $this->setName('cvterm_relationship');
        $this->setPhpName('CvtermRelationship');
        $this->setClassname('cli_db\\propel\\CvtermRelationship');
        $this->setPackage('cli_db');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('cvterm_relationship_cvterm_relationship_id_seq');
        // columns
        $this->addPrimaryKey('cvterm_relationship_id', 'CvtermRelationshipId', 'INTEGER', true, null, null);
