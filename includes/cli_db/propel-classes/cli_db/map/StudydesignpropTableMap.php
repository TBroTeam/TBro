...
/**
 * This class defines the structure of the 'studydesignprop' table.
 *
 *
 *
 ...
 */
class StudydesignpropTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cli_db.map.StudydesignpropTableMap';
    ...
    {
        // attributes
        $this->setName('studydesignprop');
        $this->setPhpName('Studydesignprop');
        $this->setClassname('cli_db\\propel\\Studydesignprop');
        $this->setPackage('cli_db');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('studydesignprop_studydesignprop_id_seq');
        // columns
        $this->addPrimaryKey('studydesignprop_id', 'StudydesignpropId', 'INTEGER', true, null, null);
