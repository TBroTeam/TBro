...
/**
 * This class defines the structure of the 'acquisitionprop' table.
 *
 *
 *
 ...
 */
class AcquisitionpropTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cli_db.map.AcquisitionpropTableMap';
    ...
    {
        // attributes
        $this->setName('acquisitionprop');
        $this->setPhpName('Acquisitionprop');
        $this->setClassname('cli_db\\propel\\Acquisitionprop');
        $this->setPackage('cli_db');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('acquisitionprop_acquisitionprop_id_seq');
        // columns
        $this->addPrimaryKey('acquisitionprop_id', 'AcquisitionpropId', 'INTEGER', true, null, null);
