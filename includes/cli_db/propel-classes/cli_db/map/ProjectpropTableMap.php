...
/**
 * This class defines the structure of the 'projectprop' table.
 *
 *
 *
 ...
 */
class ProjectpropTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cli_db.map.ProjectpropTableMap';
    ...
    {
        // attributes
        $this->setName('projectprop');
        $this->setPhpName('Projectprop');
        $this->setClassname('cli_db\\propel\\Projectprop');
        $this->setPackage('cli_db');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('projectprop_projectprop_id_seq');
        // columns
        $this->addPrimaryKey('projectprop_id', 'ProjectpropId', 'INTEGER', true, null, null);
