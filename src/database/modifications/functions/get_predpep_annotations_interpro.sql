...
BEGIN
    ...
    FROM 
        ...
        LEFT OUTER JOIN featureprop AS interpro_description ON (interpro_description.feature_id = interpro.feature_id AND interpro_description.type_id = {PHPCONST('CV_INTERPRO_DESCRIPTION')}) 
