...
/**
 * Base class that represents a row from the 'pubprop' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BasePubprop extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\PubpropPeer';
    ...
    /**
     * The value for the pubprop_id field.
     * @var        int
     */
    protected $pubprop_id;
    ...
    /**
     * Get the [pubprop_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [pubprop_id] column.
     *
     * @param int $v new value
     * @return Pubprop The current object (for fluent API support)
     */
    public function setPubpropId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->pubprop_id !== $v) {
            $this->pubprop_id = $v;
            $this->modifiedColumns[] = PubpropPeer::PUBPROP_ID;
        }
    ...
    public function setPubId($v)
    {
        ...
        if ($this->pub_id !== $v) {
            $this->pub_id = $v;
            $this->modifiedColumns[] = PubpropPeer::PUB_ID;
        }
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[] = PubpropPeer::TYPE_ID;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = PubpropPeer::VALUE;
        }
    ...
    public function setRank($v)
    {
        ...
        if ($this->rank !== $v) {
            $this->rank = $v;
            $this->modifiedColumns[] = PubpropPeer::RANK;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->pubprop_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 5; // 5 = PubpropPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Pubprop object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PubpropPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PubpropQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PubpropPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PubpropPeer::PUBPROP_ID)) {
            $modifiedColumns[':p' . $index++]  = '"pubprop_id"';
        }
        if ($this->isColumnModified(PubpropPeer::PUB_ID)) {
            $modifiedColumns[':p' . $index++]  = '"pub_id"';
        }
        if ($this->isColumnModified(PubpropPeer::TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"type_id"';
        }
        if ($this->isColumnModified(PubpropPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '"value"';
        }
        if ($this->isColumnModified(PubpropPeer::RANK)) {
            $modifiedColumns[':p' . $index++]  = '"rank"';
        }

        $sql = sprintf(
            'INSERT INTO "pubprop" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"pubprop_id"':
                        $stmt->bindValue($identifier, $this->pubprop_id, PDO::PARAM_INT);
                        break;
                    case '"pub_id"':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PubpropPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PubpropPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Pubprop'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Pubprop'][$this->getPrimaryKey()] = true;
        $keys = PubpropPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getPubpropId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setPubpropId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PubpropPeer::PUBPROP_ID)) $criteria->add(PubpropPeer::PUBPROP_ID, $this->pubprop_id);
        if ($this->isColumnModified(PubpropPeer::PUB_ID)) $criteria->add(PubpropPeer::PUB_ID, $this->pub_id);
        if ($this->isColumnModified(PubpropPeer::TYPE_ID)) $criteria->add(PubpropPeer::TYPE_ID, $this->type_id);
        if ($this->isColumnModified(PubpropPeer::VALUE)) $criteria->add(PubpropPeer::VALUE, $this->value);
        if ($this->isColumnModified(PubpropPeer::RANK)) $criteria->add(PubpropPeer::RANK, $this->rank);
    ...
    {
        $criteria = new Criteria(PubpropPeer::DATABASE_NAME);
        $criteria->add(PubpropPeer::PUBPROP_ID, $this->pubprop_id);
    ...
    /**
     * Generic method to set the primary key (pubprop_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of Pubprop (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setPubpropId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Pubprop Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PubpropPeer::DEFAULT_STRING_FORMAT);
    }
