...
<meta http-equiv="X-UA-Compatible" content="chrome=1">
    ...
    <div class="row">
        <div class="large-12 columns panel">
            <h4>Sequence</h4><div class="right"><a href="http://blast.ncbi.nlm.nih.gov/Blast.cgi?PROGRAM=blastn&PAGE_TYPE=BlastSearch&QUERY={#$data.isoform.name#}&#10;{#$data.isoform.residues#}" class="button">BLAST @ NCBI</a></div>
