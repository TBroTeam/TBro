            ...
            <div class="row">
                <div class="large-12 columns panel">
                    <div class="row"><div class="large-12 columns">
                        ...
                        <div class="right"><a target="_blank" href="http://blast.ncbi.nlm.nih.gov/Blast.cgi?PROGRAM=blastp&PAGE_TYPE=BlastSearch&QUERY={#foreach $predpeps as $predpep#}>{#$predpep.name#}%0A{#$predpep.residues#}%0A{#/foreach#}" class="button">blastp @ NCBI</a></div>
                        <div class="right"><a target="_blank" href="https://blast.ncbi.nlm.nih.gov/smartblast/smartBlast.cgi?QUERY={#foreach $predpeps as $predpep#}>{#$predpep.name#}%0A{#$predpep.residues#}%0A{#/foreach#}" class="button">smartBLAST @ NCBI</a></div>
                    </div></div>
