...
<div id="diffexpr">
    ...
    <div class="row">
        <div class="large-6 panel" style="float:left;  width:49%">
            ...
            <div class="right">
                <button type="button" id="expression-button-gdfx-table-export" value="table" disabled="disabled">Export</button>
                <button type="button" id="expression-button-gdfx-table" value="table" disabled="disabled">Apply</button>
            </div>
        </div>
    </div>
</form>
