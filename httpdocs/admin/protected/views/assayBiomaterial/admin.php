...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('assay-biomaterial-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns' => array(
		...
		array(
				'name'=>'assay_id',
				'value'=>'GxHtml::valueEx($data->assay)',
				'filter'=>GxHtml::listDataEx(Assay::model()->findAllAttributes(null, true)),
				),
		array(
				'name'=>'biomaterial_id',
