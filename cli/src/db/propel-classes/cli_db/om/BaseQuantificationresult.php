...
/**
 * Base class that represents a row from the 'quantificationresult' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseQuantificationresult extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\QuantificationresultPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        QuantificationresultPeer
     */
     ...
     * @return Quantificationresult The current object (for fluent API support)
     */
    public function setQuantificationresultId($v)
    {
        ...
        if ($this->quantificationresult_id !== $v) {
            ...
            $this->modifiedColumns[] = QuantificationresultPeer::QUANTIFICATIONRESULT_ID;
        }
    ...
    public function setFeatureId($v)
    {
        ...
        if ($this->feature_id !== $v) {
            $this->feature_id = $v;
            $this->modifiedColumns[] = QuantificationresultPeer::FEATURE_ID;
        }
    ...
    public function setBiomaterialId($v)
    {
        ...
        if ($this->biomaterial_id !== $v) {
            ...
            $this->modifiedColumns[] = QuantificationresultPeer::BIOMATERIAL_ID;
        }
    ...
    public function setQuantificationId($v)
    {
        ...
        if ($this->quantification_id !== $v) {
            ...
            $this->modifiedColumns[] = QuantificationresultPeer::QUANTIFICATION_ID;
        }
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[] = QuantificationresultPeer::TYPE_ID;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = QuantificationresultPeer::VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->quantificationresult_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            $this->quantification_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->type_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->value = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
            $this->resetModified();
            ...
            return $startcol + 6; // 6 = QuantificationresultPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Quantificationresult object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = QuantificationresultPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = QuantificationresultQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                QuantificationresultPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = QuantificationresultPeer::QUANTIFICATIONRESULT_ID;
        if (null !== $this->quantificationresult_id) {
        ...
        if (null === $this->quantificationresult_id) {
            try {
                $stmt = $con->query("SELECT nextval('quantificationresult_quantificationresult_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->quantificationresult_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(QuantificationresultPeer::QUANTIFICATIONRESULT_ID)) {
            $modifiedColumns[':p' . $index++]  = '"quantificationresult_id"';
        }
        if ($this->isColumnModified(QuantificationresultPeer::FEATURE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"feature_id"';
        }
        if ($this->isColumnModified(QuantificationresultPeer::BIOMATERIAL_ID)) {
            $modifiedColumns[':p' . $index++]  = '"biomaterial_id"';
        }
        if ($this->isColumnModified(QuantificationresultPeer::QUANTIFICATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '"quantification_id"';
        }
        if ($this->isColumnModified(QuantificationresultPeer::TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"type_id"';
        }
        if ($this->isColumnModified(QuantificationresultPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '"value"';
        }

        $sql = sprintf(
            'INSERT INTO "quantificationresult" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = QuantificationresultPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = QuantificationresultPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Quantificationresult'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Quantificationresult'][$this->getPrimaryKey()] = true;
        $keys = QuantificationresultPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getQuantificationresultId(),
            $keys[1] => $this->getFeatureId(),
            $keys[2] => $this->getBiomaterialId(),
            $keys[3] => $this->getQuantificationId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setQuantificationresultId($arr[$keys[0]]);
        ...
        if (array_key_exists($keys[3], $arr)) $this->setQuantificationId($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(QuantificationresultPeer::QUANTIFICATIONRESULT_ID)) $criteria->add(QuantificationresultPeer::QUANTIFICATIONRESULT_ID, $this->quantificationresult_id);
        if ($this->isColumnModified(QuantificationresultPeer::FEATURE_ID)) $criteria->add(QuantificationresultPeer::FEATURE_ID, $this->feature_id);
        if ($this->isColumnModified(QuantificationresultPeer::BIOMATERIAL_ID)) $criteria->add(QuantificationresultPeer::BIOMATERIAL_ID, $this->biomaterial_id);
        if ($this->isColumnModified(QuantificationresultPeer::QUANTIFICATION_ID)) $criteria->add(QuantificationresultPeer::QUANTIFICATION_ID, $this->quantification_id);
        if ($this->isColumnModified(QuantificationresultPeer::TYPE_ID)) $criteria->add(QuantificationresultPeer::TYPE_ID, $this->type_id);
        if ($this->isColumnModified(QuantificationresultPeer::VALUE)) $criteria->add(QuantificationresultPeer::VALUE, $this->value);
    ...
    {
        $criteria = new Criteria(QuantificationresultPeer::DATABASE_NAME);
        $criteria->add(QuantificationresultPeer::QUANTIFICATIONRESULT_ID, $this->quantificationresult_id);
    ...
    /**
     * Generic method to set the primary key (quantificationresult_id column).
     *
    ...
    {
        $this->setQuantificationresultId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getQuantificationresultId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Quantificationresult (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setQuantificationresultId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Quantificationresult Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return QuantificationresultPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new QuantificationresultPeer();
        }
    ...
    public function setBiomaterial(Biomaterial $v = null)
    {
        ...
        if ($v !== null) {
            $v->addQuantificationresult($this);
        }
    ...
    public function getBiomaterial(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBiomaterial === null && ($this->biomaterial_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBiomaterial->addQuantificationresults($this);
             */
        }
    ...
    public function getCvterm(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCvterm === null && ($this->type_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCvterm->addQuantificationresults($this);
             */
        }
    ...
    public function getFeature(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFeature === null && ($this->feature_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFeature->addQuantificationresults($this);
             */
        }
    ...
    public function getQuantification(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aQuantification === null && ($this->quantification_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aQuantification->addQuantificationresults($this);
             */
        }
     ...
     * If this Quantificationresult is new, it will return
        ...
        if (null === $this->collExpressionresultQuantificationresults || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collExpressionresultQuantificationresults) {
                ...
                $collExpressionresultQuantificationresults = ExpressionresultQuantificationresultQuery::create(null, $criteria)
                    ->filterByQuantificationresult($this)
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function setExpressionresultQuantificationresults(PropelCollection $expressionresultQuantificationresults, PropelPDO $con = null)
    {
        ...
        foreach ($expressionresultQuantificationresultsToDelete as $expressionresultQuantificationresultRemoved) {
            $expressionresultQuantificationresultRemoved->setQuantificationresult(null);
        }
    ...
    protected function doAddExpressionresultQuantificationresult($expressionresultQuantificationresult)
    {
        ...
        $expressionresultQuantificationresult->setQuantificationresult($this);
    }
    ...
    public function removeExpressionresultQuantificationresult($expressionresultQuantificationresult)
    {
        if ($this->getExpressionresultQuantificationresults()->contains($expressionresultQuantificationresult)) {
            ...
            $expressionresultQuantificationresult->setQuantificationresult(null);
        }
     ...
     * Otherwise if this Quantificationresult is new, it will return
     * an empty collection; or if this Quantificationresult has previously
     * been saved, it will retrieve related ExpressionresultQuantificationresults from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Quantificationresult.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|ExpressionresultQuantificationresult[] List of ExpressionresultQuantificationresult objects
     */
    public function getExpressionresultQuantificationresultsJoinExpressionresult($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ExpressionresultQuantificationresultQuery::create(null, $criteria);
        $query->joinWith('Expressionresult', $join_behavior);
    ...
    {
        return (string) $this->exportTo(QuantificationresultPeer::DEFAULT_STRING_FORMAT);
    }
