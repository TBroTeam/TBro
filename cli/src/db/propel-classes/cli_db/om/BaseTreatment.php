...
/**
 * Base class that represents a row from the 'treatment' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseTreatment extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\TreatmentPeer';
    ...
    /**
     * Initializes internal state of BaseTreatment object.
     * @see        applyDefaults()
     */
     ...
     * @return Treatment The current object (for fluent API support)
     */
    public function setTreatmentId($v)
    {
        ...
        if ($this->treatment_id !== $v) {
            $this->treatment_id = $v;
            $this->modifiedColumns[] = TreatmentPeer::TREATMENT_ID;
        }
    ...
    public function setRank($v)
    {
        ...
        if ($this->rank !== $v) {
            $this->rank = $v;
            $this->modifiedColumns[] = TreatmentPeer::RANK;
        }
    ...
    public function setBiomaterialId($v)
    {
        ...
        if ($this->biomaterial_id !== $v) {
            ...
            $this->modifiedColumns[] = TreatmentPeer::BIOMATERIAL_ID;
        }
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[] = TreatmentPeer::TYPE_ID;
        }
    ...
    public function setProtocolId($v)
    {
        ...
        if ($this->protocol_id !== $v) {
            $this->protocol_id = $v;
            $this->modifiedColumns[] = TreatmentPeer::PROTOCOL_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = TreatmentPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->treatment_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 6; // 6 = TreatmentPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Treatment object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TreatmentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TreatmentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TreatmentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TreatmentPeer::TREATMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '"treatment_id"';
        }
        if ($this->isColumnModified(TreatmentPeer::RANK)) {
            $modifiedColumns[':p' . $index++]  = '"rank"';
        }
        if ($this->isColumnModified(TreatmentPeer::BIOMATERIAL_ID)) {
            $modifiedColumns[':p' . $index++]  = '"biomaterial_id"';
        }
        if ($this->isColumnModified(TreatmentPeer::TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"type_id"';
        }
        if ($this->isColumnModified(TreatmentPeer::PROTOCOL_ID)) {
            $modifiedColumns[':p' . $index++]  = '"protocol_id"';
        }
        if ($this->isColumnModified(TreatmentPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '"name"';
        }

        $sql = sprintf(
            'INSERT INTO "treatment" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TreatmentPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TreatmentPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Treatment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Treatment'][$this->getPrimaryKey()] = true;
        $keys = TreatmentPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getTreatmentId(),
            $keys[1] => $this->getRank(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setTreatmentId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TreatmentPeer::TREATMENT_ID)) $criteria->add(TreatmentPeer::TREATMENT_ID, $this->treatment_id);
        if ($this->isColumnModified(TreatmentPeer::RANK)) $criteria->add(TreatmentPeer::RANK, $this->rank);
        if ($this->isColumnModified(TreatmentPeer::BIOMATERIAL_ID)) $criteria->add(TreatmentPeer::BIOMATERIAL_ID, $this->biomaterial_id);
        if ($this->isColumnModified(TreatmentPeer::TYPE_ID)) $criteria->add(TreatmentPeer::TYPE_ID, $this->type_id);
        if ($this->isColumnModified(TreatmentPeer::PROTOCOL_ID)) $criteria->add(TreatmentPeer::PROTOCOL_ID, $this->protocol_id);
        if ($this->isColumnModified(TreatmentPeer::NAME)) $criteria->add(TreatmentPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(TreatmentPeer::DATABASE_NAME);
        $criteria->add(TreatmentPeer::TREATMENT_ID, $this->treatment_id);
    ...
    /**
     * Generic method to set the primary key (treatment_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getTreatmentId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Treatment (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setTreatmentId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Treatment Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TreatmentPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TreatmentPeer();
        }
    ...
    public function getBiomaterial(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBiomaterial === null && ($this->biomaterial_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBiomaterial->addTreatments($this);
             */
        }
    ...
    public function getProtocol(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProtocol === null && ($this->protocol_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProtocol->addTreatments($this);
             */
        }
    ...
    public function getCvterm(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCvterm === null && ($this->type_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCvterm->addTreatments($this);
             */
        }
     ...
     * If this Treatment is new, it will return
    ...
    public function setBiomaterialTreatments(PropelCollection $biomaterialTreatments, PropelPDO $con = null)
    {
        ...
        foreach ($biomaterialTreatmentsToDelete as $biomaterialTreatmentRemoved) {
            $biomaterialTreatmentRemoved->setTreatment(null);
        }
    ...
    protected function doAddBiomaterialTreatment($biomaterialTreatment)
    {
        ...
        $biomaterialTreatment->setTreatment($this);
    }
    ...
    public function removeBiomaterialTreatment($biomaterialTreatment)
    {
        if ($this->getBiomaterialTreatments()->contains($biomaterialTreatment)) {
            ...
            $biomaterialTreatment->setTreatment(null);
        }
     ...
     * Otherwise if this Treatment is new, it will return
     * an empty collection; or if this Treatment has previously
     * been saved, it will retrieve related BiomaterialTreatments from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Treatment.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(TreatmentPeer::DEFAULT_STRING_FORMAT);
    }
