...
abstract class BasePub extends BaseObject implements Persistent
{
    ...
    public function setFeatureRelationshipPubs(PropelCollection $featureRelationshipPubs, PropelPDO $con = null)
    {
        ...
        foreach ($featureRelationshipPubsToDelete as $featureRelationshipPubRemoved) {
            $featureRelationshipPubRemoved->setPub(null);
        }
     ...
     * @return PropelObjectCollection|FeatureRelationshipPub[] List of FeatureRelationshipPub objects
     */
    public function getFeatureRelationshipPubsJoinFeatureRelationship($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = FeatureRelationshipPubQuery::create(null, $criteria);
    ...
    public function setFeatureRelationshippropPubs(PropelCollection $featureRelationshippropPubs, PropelPDO $con = null)
    {
        ...
        foreach ($featureRelationshippropPubsToDelete as $featureRelationshippropPubRemoved) {
            $featureRelationshippropPubRemoved->setPub(null);
        }
     ...
     * @return PropelObjectCollection|FeatureRelationshippropPub[] List of FeatureRelationshippropPub objects
     */
    public function getFeatureRelationshippropPubsJoinFeatureRelationshipprop($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = FeatureRelationshippropPubQuery::create(null, $criteria);
        $query->joinWith('FeatureRelationshipprop', $join_behavior);
    ...
    public function setFeaturelocPubs(PropelCollection $featurelocPubs, PropelPDO $con = null)
    {
        ...
        foreach ($featurelocPubsToDelete as $featurelocPubRemoved) {
            $featurelocPubRemoved->setPub(null);
        }
     ...
     * @return PropelObjectCollection|FeaturelocPub[] List of FeaturelocPub objects
     */
    public function getFeaturelocPubsJoinFeatureloc($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = FeaturelocPubQuery::create(null, $criteria);
        $query->joinWith('Featureloc', $join_behavior);
    ...
    public function setFeaturepropPubs(PropelCollection $featurepropPubs, PropelPDO $con = null)
    {
        ...
        foreach ($featurepropPubsToDelete as $featurepropPubRemoved) {
            $featurepropPubRemoved->setPub(null);
        }
     ...
     * @return PropelObjectCollection|FeaturepropPub[] List of FeaturepropPub objects
     */
    public function getFeaturepropPubsJoinFeatureprop($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = FeaturepropPubQuery::create(null, $criteria);
        $query->joinWith('Featureprop', $join_behavior);
     ...
     * @return PropelObjectCollection|ProjectPub[] List of ProjectPub objects
     */
    public function getProjectPubsJoinProject($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ProjectPubQuery::create(null, $criteria);
