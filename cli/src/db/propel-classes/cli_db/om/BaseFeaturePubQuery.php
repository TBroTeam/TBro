 ...
 *
 * @method FeaturePubQuery leftJoinFeaturePubprop($relationAlias = null) Adds a LEFT JOIN clause to the query using the FeaturePubprop relation
 * @method FeaturePubQuery rightJoinFeaturePubprop($relationAlias = null) Adds a RIGHT JOIN clause to the query using the FeaturePubprop relation
 * @method FeaturePubQuery innerJoinFeaturePubprop($relationAlias = null) Adds a INNER JOIN clause to the query using the FeaturePubprop relation
 *
...
abstract class BaseFeaturePubQuery extends ModelCriteria
{
    ...
    public function filterByFeaturePubprop($featurePubprop, $comparison = null)
    {
        if ($featurePubprop instanceof FeaturePubprop) {
            return $this
                ->addUsingAlias(FeaturePubPeer::FEATURE_PUB_ID, $featurePubprop->getFeaturePubId(), $comparison);
