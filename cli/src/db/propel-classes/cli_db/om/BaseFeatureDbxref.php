...
/**
 * Base class that represents a row from the 'feature_dbxref' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseFeatureDbxref extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\FeatureDbxrefPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FeatureDbxrefPeer
     */
    ...
    /**
     * The value for the feature_dbxref_id field.
     * @var        int
     */
    protected $feature_dbxref_id;
    ...
    /**
     * Initializes internal state of BaseFeatureDbxref object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [feature_dbxref_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [feature_dbxref_id] column.
     *
     * @param int $v new value
     * @return FeatureDbxref The current object (for fluent API support)
     */
    public function setFeatureDbxrefId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->feature_dbxref_id !== $v) {
            $this->feature_dbxref_id = $v;
            $this->modifiedColumns[] = FeatureDbxrefPeer::FEATURE_DBXREF_ID;
        }
    ...
    public function setFeatureId($v)
    {
        ...
        if ($this->feature_id !== $v) {
            $this->feature_id = $v;
            $this->modifiedColumns[] = FeatureDbxrefPeer::FEATURE_ID;
        }
    ...
    public function setDbxrefId($v)
    {
        ...
        if ($this->dbxref_id !== $v) {
            $this->dbxref_id = $v;
            $this->modifiedColumns[] = FeatureDbxrefPeer::DBXREF_ID;
        }
    ...
    public function setIsCurrent($v)
    {
        ...
        if ($this->is_current !== $v) {
            $this->is_current = $v;
            $this->modifiedColumns[] = FeatureDbxrefPeer::IS_CURRENT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->feature_dbxref_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->feature_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->dbxref_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->is_current = ($row[$startcol + 3] !== null) ? (boolean) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = FeatureDbxrefPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FeatureDbxref object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FeatureDbxrefPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FeatureDbxrefQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FeatureDbxrefPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = FeatureDbxrefPeer::FEATURE_DBXREF_ID;
        if (null !== $this->feature_dbxref_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . FeatureDbxrefPeer::FEATURE_DBXREF_ID . ')');
        }
        if (null === $this->feature_dbxref_id) {
            try {
                $stmt = $con->query("SELECT nextval('feature_dbxref_feature_dbxref_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->feature_dbxref_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(FeatureDbxrefPeer::FEATURE_DBXREF_ID)) {
            $modifiedColumns[':p' . $index++]  = '"feature_dbxref_id"';
        }
        if ($this->isColumnModified(FeatureDbxrefPeer::FEATURE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"feature_id"';
        }
        if ($this->isColumnModified(FeatureDbxrefPeer::DBXREF_ID)) {
            $modifiedColumns[':p' . $index++]  = '"dbxref_id"';
        }
        if ($this->isColumnModified(FeatureDbxrefPeer::IS_CURRENT)) {
            $modifiedColumns[':p' . $index++]  = '"is_current"';
        }

        $sql = sprintf(
            'INSERT INTO "feature_dbxref" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"feature_dbxref_id"':
                        $stmt->bindValue($identifier, $this->feature_dbxref_id, PDO::PARAM_INT);
                        break;
                    case '"feature_id"':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FeatureDbxrefPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FeatureDbxrefPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getFeatureDbxrefId();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['FeatureDbxref'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FeatureDbxref'][$this->getPrimaryKey()] = true;
        $keys = FeatureDbxrefPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getFeatureDbxrefId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setFeatureDbxrefId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FeatureDbxrefPeer::FEATURE_DBXREF_ID)) $criteria->add(FeatureDbxrefPeer::FEATURE_DBXREF_ID, $this->feature_dbxref_id);
        if ($this->isColumnModified(FeatureDbxrefPeer::FEATURE_ID)) $criteria->add(FeatureDbxrefPeer::FEATURE_ID, $this->feature_id);
        if ($this->isColumnModified(FeatureDbxrefPeer::DBXREF_ID)) $criteria->add(FeatureDbxrefPeer::DBXREF_ID, $this->dbxref_id);
        if ($this->isColumnModified(FeatureDbxrefPeer::IS_CURRENT)) $criteria->add(FeatureDbxrefPeer::IS_CURRENT, $this->is_current);
    ...
    {
        $criteria = new Criteria(FeatureDbxrefPeer::DATABASE_NAME);
        $criteria->add(FeatureDbxrefPeer::FEATURE_DBXREF_ID, $this->feature_dbxref_id);
    ...
    /**
     * Generic method to set the primary key (feature_dbxref_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getFeatureDbxrefId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of FeatureDbxref (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setFeatureDbxrefId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FeatureDbxref Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FeatureDbxrefPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FeatureDbxrefPeer();
        }
    ...
    public function getDbxref(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDbxref === null && ($this->dbxref_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDbxref->addFeatureDbxrefs($this);
             */
        }
    ...
    public function getFeature(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFeature === null && ($this->feature_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aFeature->addFeatureDbxrefs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(FeatureDbxrefPeer::DEFAULT_STRING_FORMAT);
    }
