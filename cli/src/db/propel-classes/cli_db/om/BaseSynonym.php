...
/**
 * Base class that represents a row from the 'synonym' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseSynonym extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\SynonymPeer';
    ...
    /**
     * The value for the synonym_sgml field.
     * @var        string
     */
    protected $synonym_sgml;
    ...
    /**
     * Get the [synonym_sgml] column value.
     *
     * @return string
     */
     ...
     * @return Synonym The current object (for fluent API support)
     */
    public function setSynonymId($v)
    {
        ...
        if ($this->synonym_id !== $v) {
            $this->synonym_id = $v;
            $this->modifiedColumns[] = SynonymPeer::SYNONYM_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = SynonymPeer::NAME;
        }
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[] = SynonymPeer::TYPE_ID;
        }
    ...
    /**
     * Set the value of [synonym_sgml] column.
     *
     * @param string $v new value
     * @return Synonym The current object (for fluent API support)
     */
    public function setSynonymSgml($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->synonym_sgml !== $v) {
            $this->synonym_sgml = $v;
            $this->modifiedColumns[] = SynonymPeer::SYNONYM_SGML;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->synonym_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->name = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->type_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->synonym_sgml = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = SynonymPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Synonym object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SynonymPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SynonymQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SynonymPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SynonymPeer::SYNONYM_ID)) {
            $modifiedColumns[':p' . $index++]  = '"synonym_id"';
        }
        if ($this->isColumnModified(SynonymPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '"name"';
        }
        if ($this->isColumnModified(SynonymPeer::TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"type_id"';
        }
        if ($this->isColumnModified(SynonymPeer::SYNONYM_SGML)) {
            $modifiedColumns[':p' . $index++]  = '"synonym_sgml"';
        }

        $sql = sprintf(
            'INSERT INTO "synonym" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"type_id"':
                        ...
                        break;
                    case '"synonym_sgml"':
                        $stmt->bindValue($identifier, $this->synonym_sgml, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SynonymPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SynonymPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Synonym'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Synonym'][$this->getPrimaryKey()] = true;
        $keys = SynonymPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getSynonymId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getTypeId(),
            $keys[3] => $this->getSynonymSgml(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setSynonymId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setName($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setTypeId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setSynonymSgml($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SynonymPeer::SYNONYM_ID)) $criteria->add(SynonymPeer::SYNONYM_ID, $this->synonym_id);
        if ($this->isColumnModified(SynonymPeer::NAME)) $criteria->add(SynonymPeer::NAME, $this->name);
        if ($this->isColumnModified(SynonymPeer::TYPE_ID)) $criteria->add(SynonymPeer::TYPE_ID, $this->type_id);
        if ($this->isColumnModified(SynonymPeer::SYNONYM_SGML)) $criteria->add(SynonymPeer::SYNONYM_SGML, $this->synonym_sgml);
    ...
    {
        $criteria = new Criteria(SynonymPeer::DATABASE_NAME);
        $criteria->add(SynonymPeer::SYNONYM_ID, $this->synonym_id);
    ...
    /**
     * Generic method to set the primary key (synonym_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of Synonym (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setSynonymSgml($this->getSynonymSgml());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setSynonymId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Synonym Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Synonym is new, it will return
    ...
    public function setFeatureSynonyms(PropelCollection $featureSynonyms, PropelPDO $con = null)
    {
        ...
        foreach ($featureSynonymsToDelete as $featureSynonymRemoved) {
            $featureSynonymRemoved->setSynonym(null);
        }
    ...
    protected function doAddFeatureSynonym($featureSynonym)
    {
        ...
        $featureSynonym->setSynonym($this);
    }
    ...
    public function removeFeatureSynonym($featureSynonym)
    {
        if ($this->getFeatureSynonyms()->contains($featureSynonym)) {
            ...
            $featureSynonym->setSynonym(null);
        }
     ...
     * Otherwise if this Synonym is new, it will return
     * an empty collection; or if this Synonym has previously
     * been saved, it will retrieve related FeatureSynonyms from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Synonym.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(SynonymPeer::DEFAULT_STRING_FORMAT);
    }
