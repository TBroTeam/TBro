...
/**
 * Base class that represents a row from the 'acquisitionprop' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseAcquisitionprop extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\AcquisitionpropPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        AcquisitionpropPeer
     */
    ...
    /**
     * The value for the acquisitionprop_id field.
     * @var        int
     */
    protected $acquisitionprop_id;
    ...
    /**
     * Initializes internal state of BaseAcquisitionprop object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [acquisitionprop_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [acquisitionprop_id] column.
     *
     * @param int $v new value
     * @return Acquisitionprop The current object (for fluent API support)
     */
    public function setAcquisitionpropId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->acquisitionprop_id !== $v) {
            $this->acquisitionprop_id = $v;
            $this->modifiedColumns[] = AcquisitionpropPeer::ACQUISITIONPROP_ID;
        }


        return $this;
    } // setAcquisitionpropId()
    ...
    public function setAcquisitionId($v)
    {
        ...
        if ($this->acquisition_id !== $v) {
            ...
            $this->modifiedColumns[] = AcquisitionpropPeer::ACQUISITION_ID;
        }
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[] = AcquisitionpropPeer::TYPE_ID;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = AcquisitionpropPeer::VALUE;
        }
    ...
    public function setRank($v)
    {
        ...
        if ($this->rank !== $v) {
            $this->rank = $v;
            $this->modifiedColumns[] = AcquisitionpropPeer::RANK;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->acquisitionprop_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 5; // 5 = AcquisitionpropPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Acquisitionprop object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AcquisitionpropPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = AcquisitionpropQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AcquisitionpropPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = AcquisitionpropPeer::ACQUISITIONPROP_ID;
        if (null !== $this->acquisitionprop_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AcquisitionpropPeer::ACQUISITIONPROP_ID . ')');
        }
        if (null === $this->acquisitionprop_id) {
            try {
                $stmt = $con->query("SELECT nextval('acquisitionprop_acquisitionprop_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->acquisitionprop_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(AcquisitionpropPeer::ACQUISITIONPROP_ID)) {
            $modifiedColumns[':p' . $index++]  = '"acquisitionprop_id"';
        }
        if ($this->isColumnModified(AcquisitionpropPeer::ACQUISITION_ID)) {
            $modifiedColumns[':p' . $index++]  = '"acquisition_id"';
        }
        if ($this->isColumnModified(AcquisitionpropPeer::TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"type_id"';
        }
        if ($this->isColumnModified(AcquisitionpropPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '"value"';
        }
        if ($this->isColumnModified(AcquisitionpropPeer::RANK)) {
            $modifiedColumns[':p' . $index++]  = '"rank"';
        }

        $sql = sprintf(
            'INSERT INTO "acquisitionprop" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"acquisitionprop_id"':
                        $stmt->bindValue($identifier, $this->acquisitionprop_id, PDO::PARAM_INT);
                        break;
                    case '"acquisition_id"':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AcquisitionpropPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AcquisitionpropPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getAcquisitionpropId();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['Acquisitionprop'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Acquisitionprop'][$this->getPrimaryKey()] = true;
        $keys = AcquisitionpropPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAcquisitionpropId(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setAcquisitionpropId($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setAcquisitionpropId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AcquisitionpropPeer::ACQUISITIONPROP_ID)) $criteria->add(AcquisitionpropPeer::ACQUISITIONPROP_ID, $this->acquisitionprop_id);
        if ($this->isColumnModified(AcquisitionpropPeer::ACQUISITION_ID)) $criteria->add(AcquisitionpropPeer::ACQUISITION_ID, $this->acquisition_id);
        if ($this->isColumnModified(AcquisitionpropPeer::TYPE_ID)) $criteria->add(AcquisitionpropPeer::TYPE_ID, $this->type_id);
        if ($this->isColumnModified(AcquisitionpropPeer::VALUE)) $criteria->add(AcquisitionpropPeer::VALUE, $this->value);
        if ($this->isColumnModified(AcquisitionpropPeer::RANK)) $criteria->add(AcquisitionpropPeer::RANK, $this->rank);
    ...
    {
        $criteria = new Criteria(AcquisitionpropPeer::DATABASE_NAME);
        $criteria->add(AcquisitionpropPeer::ACQUISITIONPROP_ID, $this->acquisitionprop_id);
    ...
    /**
     * Generic method to set the primary key (acquisitionprop_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getAcquisitionpropId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Acquisitionprop (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setAcquisitionpropId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Acquisitionprop Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return AcquisitionpropPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new AcquisitionpropPeer();
        }
    ...
    public function getAcquisition(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAcquisition === null && ($this->acquisition_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAcquisition->addAcquisitionprops($this);
             */
        }
    ...
    public function getCvterm(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCvterm === null && ($this->type_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCvterm->addAcquisitionprops($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(AcquisitionpropPeer::DEFAULT_STRING_FORMAT);
    }
