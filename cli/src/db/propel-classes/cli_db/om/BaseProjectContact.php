...
/**
 * Base class that represents a row from the 'project_contact' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseProjectContact extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\ProjectContactPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProjectContactPeer
     */
    ...
    /**
     * The value for the project_contact_id field.
     * @var        int
     */
    protected $project_contact_id;
    ...
    /**
     * Get the [project_contact_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [project_contact_id] column.
     *
     * @param int $v new value
     * @return ProjectContact The current object (for fluent API support)
     */
    public function setProjectContactId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->project_contact_id !== $v) {
            $this->project_contact_id = $v;
            $this->modifiedColumns[] = ProjectContactPeer::PROJECT_CONTACT_ID;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[] = ProjectContactPeer::PROJECT_ID;
        }
    ...
    public function setContactId($v)
    {
        ...
        if ($this->contact_id !== $v) {
            $this->contact_id = $v;
            $this->modifiedColumns[] = ProjectContactPeer::CONTACT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->project_contact_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = ProjectContactPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProjectContact object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProjectContactPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProjectContactQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProjectContactPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ProjectContactPeer::PROJECT_CONTACT_ID;
        if (null !== $this->project_contact_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ProjectContactPeer::PROJECT_CONTACT_ID . ')');
        }
        if (null === $this->project_contact_id) {
            try {
                $stmt = $con->query("SELECT nextval('project_contact_project_contact_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->project_contact_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(ProjectContactPeer::PROJECT_CONTACT_ID)) {
            $modifiedColumns[':p' . $index++]  = '"project_contact_id"';
        }
        if ($this->isColumnModified(ProjectContactPeer::PROJECT_ID)) {
            $modifiedColumns[':p' . $index++]  = '"project_id"';
        }
        if ($this->isColumnModified(ProjectContactPeer::CONTACT_ID)) {
            $modifiedColumns[':p' . $index++]  = '"contact_id"';
        }

        $sql = sprintf(
            'INSERT INTO "project_contact" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"project_contact_id"':
                        $stmt->bindValue($identifier, $this->project_contact_id, PDO::PARAM_INT);
                        break;
                    case '"project_id"':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProjectContactPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProjectContactPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getProjectContactId();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['ProjectContact'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectContact'][$this->getPrimaryKey()] = true;
        $keys = ProjectContactPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getProjectContactId(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setProjectContactId($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setProjectContactId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectContactPeer::PROJECT_CONTACT_ID)) $criteria->add(ProjectContactPeer::PROJECT_CONTACT_ID, $this->project_contact_id);
        if ($this->isColumnModified(ProjectContactPeer::PROJECT_ID)) $criteria->add(ProjectContactPeer::PROJECT_ID, $this->project_id);
        if ($this->isColumnModified(ProjectContactPeer::CONTACT_ID)) $criteria->add(ProjectContactPeer::CONTACT_ID, $this->contact_id);
    ...
    {
        $criteria = new Criteria(ProjectContactPeer::DATABASE_NAME);
        $criteria->add(ProjectContactPeer::PROJECT_CONTACT_ID, $this->project_contact_id);
    ...
    /**
     * Generic method to set the primary key (project_contact_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getProjectContactId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProjectContact (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setProjectContactId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProjectContact Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProjectContactPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProjectContactPeer();
        }
    ...
    public function getContact(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aContact === null && ($this->contact_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aContact->addProjectContacts($this);
             */
        }
    ...
    public function getProject(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProject === null && ($this->project_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProject->addProjectContacts($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProjectContactPeer::DEFAULT_STRING_FORMAT);
    }
