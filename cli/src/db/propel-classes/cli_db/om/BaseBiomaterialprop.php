...
/**
 * Base class that represents a row from the 'biomaterialprop' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseBiomaterialprop extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\BiomaterialpropPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        BiomaterialpropPeer
     */
    ...
    /**
     * The value for the biomaterialprop_id field.
     * @var        int
     */
    protected $biomaterialprop_id;
    ...
    /**
     * Initializes internal state of BaseBiomaterialprop object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [biomaterialprop_id] column value.
     *
     * @return int
     */
    public function getBiomaterialpropId()
    {
        return $this->biomaterialprop_id;
    }
    ...
    /**
     * Set the value of [biomaterialprop_id] column.
     *
     * @param int $v new value
     * @return Biomaterialprop The current object (for fluent API support)
     */
    public function setBiomaterialpropId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->biomaterialprop_id !== $v) {
            $this->biomaterialprop_id = $v;
            $this->modifiedColumns[] = BiomaterialpropPeer::BIOMATERIALPROP_ID;
        }


        return $this;
    } // setBiomaterialpropId()
    ...
    public function setBiomaterialId($v)
    {
        ...
        if ($this->biomaterial_id !== $v) {
            ...
            $this->modifiedColumns[] = BiomaterialpropPeer::BIOMATERIAL_ID;
        }
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[] = BiomaterialpropPeer::TYPE_ID;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = BiomaterialpropPeer::VALUE;
        }
    ...
    public function setRank($v)
    {
        ...
        if ($this->rank !== $v) {
            $this->rank = $v;
            $this->modifiedColumns[] = BiomaterialpropPeer::RANK;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->biomaterialprop_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 5; // 5 = BiomaterialpropPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Biomaterialprop object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BiomaterialpropPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BiomaterialpropQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BiomaterialpropPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = BiomaterialpropPeer::BIOMATERIALPROP_ID;
        if (null !== $this->biomaterialprop_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . BiomaterialpropPeer::BIOMATERIALPROP_ID . ')');
        }
        if (null === $this->biomaterialprop_id) {
            try {
                $stmt = $con->query("SELECT nextval('biomaterialprop_biomaterialprop_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->biomaterialprop_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(BiomaterialpropPeer::BIOMATERIALPROP_ID)) {
            $modifiedColumns[':p' . $index++]  = '"biomaterialprop_id"';
        }
        if ($this->isColumnModified(BiomaterialpropPeer::BIOMATERIAL_ID)) {
            $modifiedColumns[':p' . $index++]  = '"biomaterial_id"';
        }
        if ($this->isColumnModified(BiomaterialpropPeer::TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"type_id"';
        }
        if ($this->isColumnModified(BiomaterialpropPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '"value"';
        }
        if ($this->isColumnModified(BiomaterialpropPeer::RANK)) {
            $modifiedColumns[':p' . $index++]  = '"rank"';
        }

        $sql = sprintf(
            'INSERT INTO "biomaterialprop" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"biomaterialprop_id"':
                        $stmt->bindValue($identifier, $this->biomaterialprop_id, PDO::PARAM_INT);
                        break;
                    case '"biomaterial_id"':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BiomaterialpropPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BiomaterialpropPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getBiomaterialpropId();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['Biomaterialprop'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Biomaterialprop'][$this->getPrimaryKey()] = true;
        $keys = BiomaterialpropPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getBiomaterialpropId(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setBiomaterialpropId($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setBiomaterialpropId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BiomaterialpropPeer::BIOMATERIALPROP_ID)) $criteria->add(BiomaterialpropPeer::BIOMATERIALPROP_ID, $this->biomaterialprop_id);
        if ($this->isColumnModified(BiomaterialpropPeer::BIOMATERIAL_ID)) $criteria->add(BiomaterialpropPeer::BIOMATERIAL_ID, $this->biomaterial_id);
        if ($this->isColumnModified(BiomaterialpropPeer::TYPE_ID)) $criteria->add(BiomaterialpropPeer::TYPE_ID, $this->type_id);
        if ($this->isColumnModified(BiomaterialpropPeer::VALUE)) $criteria->add(BiomaterialpropPeer::VALUE, $this->value);
        if ($this->isColumnModified(BiomaterialpropPeer::RANK)) $criteria->add(BiomaterialpropPeer::RANK, $this->rank);
    ...
    {
        $criteria = new Criteria(BiomaterialpropPeer::DATABASE_NAME);
        $criteria->add(BiomaterialpropPeer::BIOMATERIALPROP_ID, $this->biomaterialprop_id);
    ...
    /**
     * Generic method to set the primary key (biomaterialprop_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getBiomaterialpropId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Biomaterialprop (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setBiomaterialpropId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Biomaterialprop Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BiomaterialpropPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BiomaterialpropPeer();
        }
    ...
    public function getBiomaterial(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBiomaterial === null && ($this->biomaterial_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBiomaterial->addBiomaterialprops($this);
             */
        }
    ...
    public function getCvterm(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCvterm === null && ($this->type_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCvterm->addBiomaterialprops($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BiomaterialpropPeer::DEFAULT_STRING_FORMAT);
    }
