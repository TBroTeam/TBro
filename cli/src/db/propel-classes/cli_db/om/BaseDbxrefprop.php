...
/**
 * Base class that represents a row from the 'dbxrefprop' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseDbxrefprop extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\DbxrefpropPeer';
    ...
    /**
     * The value for the dbxrefprop_id field.
     * @var        int
     */
    protected $dbxrefprop_id;
    ...
    /**
     * Initializes internal state of BaseDbxrefprop object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [dbxrefprop_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [dbxrefprop_id] column.
     *
     * @param int $v new value
     * @return Dbxrefprop The current object (for fluent API support)
     */
    public function setDbxrefpropId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->dbxrefprop_id !== $v) {
            $this->dbxrefprop_id = $v;
            $this->modifiedColumns[] = DbxrefpropPeer::DBXREFPROP_ID;
        }
    ...
    public function setDbxrefId($v)
    {
        ...
        if ($this->dbxref_id !== $v) {
            $this->dbxref_id = $v;
            $this->modifiedColumns[] = DbxrefpropPeer::DBXREF_ID;
        }
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[] = DbxrefpropPeer::TYPE_ID;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = DbxrefpropPeer::VALUE;
        }
    ...
    public function setRank($v)
    {
        ...
        if ($this->rank !== $v) {
            $this->rank = $v;
            $this->modifiedColumns[] = DbxrefpropPeer::RANK;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->dbxrefprop_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 5; // 5 = DbxrefpropPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Dbxrefprop object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DbxrefpropPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DbxrefpropQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DbxrefpropPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = DbxrefpropPeer::DBXREFPROP_ID;
        if (null !== $this->dbxrefprop_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . DbxrefpropPeer::DBXREFPROP_ID . ')');
        }
        if (null === $this->dbxrefprop_id) {
            try {
                $stmt = $con->query("SELECT nextval('dbxrefprop_dbxrefprop_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->dbxrefprop_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(DbxrefpropPeer::DBXREFPROP_ID)) {
            $modifiedColumns[':p' . $index++]  = '"dbxrefprop_id"';
        }
        if ($this->isColumnModified(DbxrefpropPeer::DBXREF_ID)) {
            $modifiedColumns[':p' . $index++]  = '"dbxref_id"';
        }
        if ($this->isColumnModified(DbxrefpropPeer::TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"type_id"';
        }
        if ($this->isColumnModified(DbxrefpropPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '"value"';
        }
        if ($this->isColumnModified(DbxrefpropPeer::RANK)) {
            $modifiedColumns[':p' . $index++]  = '"rank"';
        }

        $sql = sprintf(
            'INSERT INTO "dbxrefprop" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"dbxrefprop_id"':
                        $stmt->bindValue($identifier, $this->dbxrefprop_id, PDO::PARAM_INT);
                        break;
                    case '"dbxref_id"':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DbxrefpropPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DbxrefpropPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Dbxrefprop'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Dbxrefprop'][$this->getPrimaryKey()] = true;
        $keys = DbxrefpropPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getDbxrefpropId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setDbxrefpropId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DbxrefpropPeer::DBXREFPROP_ID)) $criteria->add(DbxrefpropPeer::DBXREFPROP_ID, $this->dbxrefprop_id);
        if ($this->isColumnModified(DbxrefpropPeer::DBXREF_ID)) $criteria->add(DbxrefpropPeer::DBXREF_ID, $this->dbxref_id);
        if ($this->isColumnModified(DbxrefpropPeer::TYPE_ID)) $criteria->add(DbxrefpropPeer::TYPE_ID, $this->type_id);
        if ($this->isColumnModified(DbxrefpropPeer::VALUE)) $criteria->add(DbxrefpropPeer::VALUE, $this->value);
        if ($this->isColumnModified(DbxrefpropPeer::RANK)) $criteria->add(DbxrefpropPeer::RANK, $this->rank);
    ...
    {
        $criteria = new Criteria(DbxrefpropPeer::DATABASE_NAME);
        $criteria->add(DbxrefpropPeer::DBXREFPROP_ID, $this->dbxrefprop_id);
    ...
    /**
     * Generic method to set the primary key (dbxrefprop_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getDbxrefpropId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Dbxrefprop (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setDbxrefpropId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Dbxrefprop Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DbxrefpropPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DbxrefpropPeer();
        }
    ...
    public function getDbxref(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDbxref === null && ($this->dbxref_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDbxref->addDbxrefprops($this);
             */
        }
    ...
    public function getCvterm(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCvterm === null && ($this->type_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCvterm->addDbxrefprops($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DbxrefpropPeer::DEFAULT_STRING_FORMAT);
    }
