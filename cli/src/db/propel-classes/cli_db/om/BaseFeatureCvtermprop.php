...
/**
 * Base class that represents a row from the 'feature_cvtermprop' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseFeatureCvtermprop extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\FeatureCvtermpropPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FeatureCvtermpropPeer
     */
    ...
    /**
     * The value for the feature_cvtermprop_id field.
     * @var        int
     */
    protected $feature_cvtermprop_id;
    ...
    /**
     * Initializes internal state of BaseFeatureCvtermprop object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [feature_cvtermprop_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [feature_cvtermprop_id] column.
     *
     * @param int $v new value
     * @return FeatureCvtermprop The current object (for fluent API support)
     */
    public function setFeatureCvtermpropId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->feature_cvtermprop_id !== $v) {
            $this->feature_cvtermprop_id = $v;
            $this->modifiedColumns[] = FeatureCvtermpropPeer::FEATURE_CVTERMPROP_ID;
        }


        return $this;
    } // setFeatureCvtermpropId()
    ...
    public function setFeatureCvtermId($v)
    {
        ...
        if ($this->feature_cvterm_id !== $v) {
            ...
            $this->modifiedColumns[] = FeatureCvtermpropPeer::FEATURE_CVTERM_ID;
        }
    ...
    public function setTypeId($v)
    {
        ...
        if ($this->type_id !== $v) {
            $this->type_id = $v;
            $this->modifiedColumns[] = FeatureCvtermpropPeer::TYPE_ID;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = FeatureCvtermpropPeer::VALUE;
        }
    ...
    public function setRank($v)
    {
        ...
        if ($this->rank !== $v) {
            $this->rank = $v;
            $this->modifiedColumns[] = FeatureCvtermpropPeer::RANK;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->feature_cvtermprop_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 5; // 5 = FeatureCvtermpropPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FeatureCvtermprop object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FeatureCvtermpropPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FeatureCvtermpropQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FeatureCvtermpropPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = FeatureCvtermpropPeer::FEATURE_CVTERMPROP_ID;
        if (null !== $this->feature_cvtermprop_id) {
        ...
        if (null === $this->feature_cvtermprop_id) {
            try {
                $stmt = $con->query("SELECT nextval('feature_cvtermprop_feature_cvtermprop_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->feature_cvtermprop_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(FeatureCvtermpropPeer::FEATURE_CVTERMPROP_ID)) {
            $modifiedColumns[':p' . $index++]  = '"feature_cvtermprop_id"';
        }
        if ($this->isColumnModified(FeatureCvtermpropPeer::FEATURE_CVTERM_ID)) {
            $modifiedColumns[':p' . $index++]  = '"feature_cvterm_id"';
        }
        if ($this->isColumnModified(FeatureCvtermpropPeer::TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"type_id"';
        }
        if ($this->isColumnModified(FeatureCvtermpropPeer::VALUE)) {
            $modifiedColumns[':p' . $index++]  = '"value"';
        }
        if ($this->isColumnModified(FeatureCvtermpropPeer::RANK)) {
            $modifiedColumns[':p' . $index++]  = '"rank"';
        }

        $sql = sprintf(
            'INSERT INTO "feature_cvtermprop" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"feature_cvtermprop_id"':
                        $stmt->bindValue($identifier, $this->feature_cvtermprop_id, PDO::PARAM_INT);
                        break;
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FeatureCvtermpropPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FeatureCvtermpropPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getFeatureCvtermpropId();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['FeatureCvtermprop'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FeatureCvtermprop'][$this->getPrimaryKey()] = true;
        $keys = FeatureCvtermpropPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getFeatureCvtermpropId(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setFeatureCvtermpropId($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setFeatureCvtermpropId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FeatureCvtermpropPeer::FEATURE_CVTERMPROP_ID)) $criteria->add(FeatureCvtermpropPeer::FEATURE_CVTERMPROP_ID, $this->feature_cvtermprop_id);
        if ($this->isColumnModified(FeatureCvtermpropPeer::FEATURE_CVTERM_ID)) $criteria->add(FeatureCvtermpropPeer::FEATURE_CVTERM_ID, $this->feature_cvterm_id);
        if ($this->isColumnModified(FeatureCvtermpropPeer::TYPE_ID)) $criteria->add(FeatureCvtermpropPeer::TYPE_ID, $this->type_id);
        if ($this->isColumnModified(FeatureCvtermpropPeer::VALUE)) $criteria->add(FeatureCvtermpropPeer::VALUE, $this->value);
        if ($this->isColumnModified(FeatureCvtermpropPeer::RANK)) $criteria->add(FeatureCvtermpropPeer::RANK, $this->rank);
    ...
    {
        $criteria = new Criteria(FeatureCvtermpropPeer::DATABASE_NAME);
        $criteria->add(FeatureCvtermpropPeer::FEATURE_CVTERMPROP_ID, $this->feature_cvtermprop_id);
    ...
    /**
     * Generic method to set the primary key (feature_cvtermprop_id column).
     *
    ...
    {
        $this->setFeatureCvtermpropId($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getFeatureCvtermpropId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of FeatureCvtermprop (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setFeatureCvtermpropId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FeatureCvtermprop Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FeatureCvtermpropPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FeatureCvtermpropPeer();
        }
    ...
    public function getFeatureCvterm(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFeatureCvterm === null && ($this->feature_cvterm_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFeatureCvterm->addFeatureCvtermprops($this);
             */
        }
    ...
    public function getCvterm(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCvterm === null && ($this->type_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCvterm->addFeatureCvtermprops($this);
             */
        }
    ...
    {
        $this->feature_cvtermprop_id = null;
    ...
    {
        return (string) $this->exportTo(FeatureCvtermpropPeer::DEFAULT_STRING_FORMAT);
    }
