...
/**
 * Base class that represents a row from the 'mageml' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BaseMageml extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\MagemlPeer';
    ...
    /**
     * The value for the mage_package field.
     * @var        string
     */
    protected $mage_package;

    /**
     * The value for the mage_ml field.
     * @var        string
     */
    protected $mage_ml;
    ...
    /**
     * Get the [mage_package] column value.
     *
     * @return string
     */
     ...
     * @return Mageml The current object (for fluent API support)
     */
    public function setMagemlId($v)
    {
        ...
        if ($this->mageml_id !== $v) {
            $this->mageml_id = $v;
            $this->modifiedColumns[] = MagemlPeer::MAGEML_ID;
        }
    ...
    /**
     * Set the value of [mage_package] column.
     *
     * @param string $v new value
     * @return Mageml The current object (for fluent API support)
     */
    public function setMagePackage($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->mage_package !== $v) {
            $this->mage_package = $v;
            $this->modifiedColumns[] = MagemlPeer::MAGE_PACKAGE;
        }
    ...
    /**
     * Set the value of [mage_ml] column.
     *
     * @param string $v new value
     * @return Mageml The current object (for fluent API support)
     */
    public function setMageMl($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->mage_ml !== $v) {
            $this->mage_ml = $v;
            $this->modifiedColumns[] = MagemlPeer::MAGE_ML;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->mageml_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->mage_package = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->mage_ml = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = MagemlPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Mageml object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MagemlPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MagemlQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MagemlPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MagemlPeer::MAGEML_ID)) {
            $modifiedColumns[':p' . $index++]  = '"mageml_id"';
        }
        if ($this->isColumnModified(MagemlPeer::MAGE_PACKAGE)) {
            $modifiedColumns[':p' . $index++]  = '"mage_package"';
        }
        if ($this->isColumnModified(MagemlPeer::MAGE_ML)) {
            $modifiedColumns[':p' . $index++]  = '"mage_ml"';
        }

        $sql = sprintf(
            'INSERT INTO "mageml" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"mageml_id"':
                        ...
                        break;
                    case '"mage_package"':
                        $stmt->bindValue($identifier, $this->mage_package, PDO::PARAM_STR);
                        break;
                    case '"mage_ml"':
                        $stmt->bindValue($identifier, $this->mage_ml, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = MagemlPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = MagemlPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getMagePackage();
                break;
            case 2:
                return $this->getMageMl();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Mageml'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Mageml'][$this->getPrimaryKey()] = true;
        $keys = MagemlPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getMagemlId(),
            $keys[1] => $this->getMagePackage(),
            $keys[2] => $this->getMageMl(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setMagePackage($value);
                break;
            case 2:
                $this->setMageMl($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setMagemlId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setMagePackage($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setMageMl($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MagemlPeer::MAGEML_ID)) $criteria->add(MagemlPeer::MAGEML_ID, $this->mageml_id);
        if ($this->isColumnModified(MagemlPeer::MAGE_PACKAGE)) $criteria->add(MagemlPeer::MAGE_PACKAGE, $this->mage_package);
        if ($this->isColumnModified(MagemlPeer::MAGE_ML)) $criteria->add(MagemlPeer::MAGE_ML, $this->mage_ml);
    ...
    {
        $criteria = new Criteria(MagemlPeer::DATABASE_NAME);
        $criteria->add(MagemlPeer::MAGEML_ID, $this->mageml_id);
    ...
    /**
     * Generic method to set the primary key (mageml_id column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of Mageml (or compatible) type.
    ...
    {
        $copyObj->setMagePackage($this->getMagePackage());
        $copyObj->setMageMl($this->getMageMl());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setMagemlId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Mageml Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Mageml is new, it will return
    ...
    public function setMagedocumentations(PropelCollection $magedocumentations, PropelPDO $con = null)
    {
        ...
        foreach ($magedocumentationsToDelete as $magedocumentationRemoved) {
            $magedocumentationRemoved->setMageml(null);
        }
    ...
    protected function doAddMagedocumentation($magedocumentation)
    {
        ...
        $magedocumentation->setMageml($this);
    }
    ...
    public function removeMagedocumentation($magedocumentation)
    {
        if ($this->getMagedocumentations()->contains($magedocumentation)) {
            ...
            $magedocumentation->setMageml(null);
        }
     ...
     * Otherwise if this Mageml is new, it will return
     * an empty collection; or if this Mageml has previously
     * been saved, it will retrieve related Magedocumentations from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Mageml.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Magedocumentation[] List of Magedocumentation objects
     */
    public function getMagedocumentationsJoinTableinfo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = MagedocumentationQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(MagemlPeer::DEFAULT_STRING_FORMAT);
    }
