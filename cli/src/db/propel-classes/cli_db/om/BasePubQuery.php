 ...
 *
 * @method PubQuery leftJoinFeatureRelationshipPub($relationAlias = null) Adds a LEFT JOIN clause to the query using the FeatureRelationshipPub relation
 * @method PubQuery rightJoinFeatureRelationshipPub($relationAlias = null) Adds a RIGHT JOIN clause to the query using the FeatureRelationshipPub relation
 * @method PubQuery innerJoinFeatureRelationshipPub($relationAlias = null) Adds a INNER JOIN clause to the query using the FeatureRelationshipPub relation
 *
 * @method PubQuery leftJoinFeatureRelationshippropPub($relationAlias = null) Adds a LEFT JOIN clause to the query using the FeatureRelationshippropPub relation
 * @method PubQuery rightJoinFeatureRelationshippropPub($relationAlias = null) Adds a RIGHT JOIN clause to the query using the FeatureRelationshippropPub relation
 * @method PubQuery innerJoinFeatureRelationshippropPub($relationAlias = null) Adds a INNER JOIN clause to the query using the FeatureRelationshippropPub relation
 *
 ...
 *
 * @method PubQuery leftJoinFeaturelocPub($relationAlias = null) Adds a LEFT JOIN clause to the query using the FeaturelocPub relation
 * @method PubQuery rightJoinFeaturelocPub($relationAlias = null) Adds a RIGHT JOIN clause to the query using the FeaturelocPub relation
 * @method PubQuery innerJoinFeaturelocPub($relationAlias = null) Adds a INNER JOIN clause to the query using the FeaturelocPub relation
 *
 * @method PubQuery leftJoinFeaturepropPub($relationAlias = null) Adds a LEFT JOIN clause to the query using the FeaturepropPub relation
 * @method PubQuery rightJoinFeaturepropPub($relationAlias = null) Adds a RIGHT JOIN clause to the query using the FeaturepropPub relation
 * @method PubQuery innerJoinFeaturepropPub($relationAlias = null) Adds a INNER JOIN clause to the query using the FeaturepropPub relation
 *
 * @method PubQuery leftJoinProjectPub($relationAlias = null) Adds a LEFT JOIN clause to the query using the ProjectPub relation
 * @method PubQuery rightJoinProjectPub($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ProjectPub relation
 * @method PubQuery innerJoinProjectPub($relationAlias = null) Adds a INNER JOIN clause to the query using the ProjectPub relation
 *
 * @method PubQuery leftJoinProtocol($relationAlias = null) Adds a LEFT JOIN clause to the query using the Protocol relation
 * @method PubQuery rightJoinProtocol($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Protocol relation
 * @method PubQuery innerJoinProtocol($relationAlias = null) Adds a INNER JOIN clause to the query using the Protocol relation
 *
 ...
 *
 * @method PubQuery leftJoinStudy($relationAlias = null) Adds a LEFT JOIN clause to the query using the Study relation
 * @method PubQuery rightJoinStudy($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Study relation
 * @method PubQuery innerJoinStudy($relationAlias = null) Adds a INNER JOIN clause to the query using the Study relation
 *
...
abstract class BasePubQuery extends ModelCriteria
{
    ...
    public function filterByFeatureRelationshipPub($featureRelationshipPub, $comparison = null)
    {
        if ($featureRelationshipPub instanceof FeatureRelationshipPub) {
            return $this
                ->addUsingAlias(PubPeer::PUB_ID, $featureRelationshipPub->getPubId(), $comparison);
    ...
    public function filterByFeatureRelationshippropPub($featureRelationshippropPub, $comparison = null)
    {
        if ($featureRelationshippropPub instanceof FeatureRelationshippropPub) {
            return $this
                ->addUsingAlias(PubPeer::PUB_ID, $featureRelationshippropPub->getPubId(), $comparison);
    ...
    public function filterByFeaturelocPub($featurelocPub, $comparison = null)
    {
        if ($featurelocPub instanceof FeaturelocPub) {
            return $this
                ->addUsingAlias(PubPeer::PUB_ID, $featurelocPub->getPubId(), $comparison);
    ...
    public function filterByFeaturepropPub($featurepropPub, $comparison = null)
    {
        if ($featurepropPub instanceof FeaturepropPub) {
            return $this
                ->addUsingAlias(PubPeer::PUB_ID, $featurepropPub->getPubId(), $comparison);
    ...
    public function filterByProjectPub($projectPub, $comparison = null)
    {
        if ($projectPub instanceof ProjectPub) {
            return $this
                ->addUsingAlias(PubPeer::PUB_ID, $projectPub->getPubId(), $comparison);
    ...
    public function filterByProtocol($protocol, $comparison = null)
    {
        if ($protocol instanceof Protocol) {
            return $this
                ->addUsingAlias(PubPeer::PUB_ID, $protocol->getPubId(), $comparison);
    ...
    public function filterByStudy($study, $comparison = null)
    {
        if ($study instanceof Study) {
            return $this
                ->addUsingAlias(PubPeer::PUB_ID, $study->getPubId(), $comparison);
