...
/**
 * Base class that represents a row from the 'pub_dbxref' table.
 *
 *
 *
 * @package    propel.generator.cli_db.om
 */
abstract class BasePubDbxref extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'cli_db\\propel\\PubDbxrefPeer';
    ...
    /**
     * The value for the pub_dbxref_id field.
     * @var        int
     */
    protected $pub_dbxref_id;
    ...
    /**
     * Initializes internal state of BasePubDbxref object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [pub_dbxref_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [pub_dbxref_id] column.
     *
     * @param int $v new value
     * @return PubDbxref The current object (for fluent API support)
     */
    public function setPubDbxrefId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->pub_dbxref_id !== $v) {
            $this->pub_dbxref_id = $v;
            $this->modifiedColumns[] = PubDbxrefPeer::PUB_DBXREF_ID;
        }
    ...
    public function setPubId($v)
    {
        ...
        if ($this->pub_id !== $v) {
            $this->pub_id = $v;
            $this->modifiedColumns[] = PubDbxrefPeer::PUB_ID;
        }
    ...
    public function setDbxrefId($v)
    {
        ...
        if ($this->dbxref_id !== $v) {
            $this->dbxref_id = $v;
            $this->modifiedColumns[] = PubDbxrefPeer::DBXREF_ID;
        }
    ...
    public function setIsCurrent($v)
    {
        ...
        if ($this->is_current !== $v) {
            $this->is_current = $v;
            $this->modifiedColumns[] = PubDbxrefPeer::IS_CURRENT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->pub_dbxref_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 4; // 4 = PubDbxrefPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PubDbxref object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PubDbxrefPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PubDbxrefQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PubDbxrefPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = PubDbxrefPeer::PUB_DBXREF_ID;
        if (null !== $this->pub_dbxref_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PubDbxrefPeer::PUB_DBXREF_ID . ')');
        }
        if (null === $this->pub_dbxref_id) {
            try {
                $stmt = $con->query("SELECT nextval('pub_dbxref_pub_dbxref_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->pub_dbxref_id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(PubDbxrefPeer::PUB_DBXREF_ID)) {
            $modifiedColumns[':p' . $index++]  = '"pub_dbxref_id"';
        }
        if ($this->isColumnModified(PubDbxrefPeer::PUB_ID)) {
            $modifiedColumns[':p' . $index++]  = '"pub_id"';
        }
        if ($this->isColumnModified(PubDbxrefPeer::DBXREF_ID)) {
            $modifiedColumns[':p' . $index++]  = '"dbxref_id"';
        }
        if ($this->isColumnModified(PubDbxrefPeer::IS_CURRENT)) {
            $modifiedColumns[':p' . $index++]  = '"is_current"';
        }

        $sql = sprintf(
            'INSERT INTO "pub_dbxref" (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '"pub_dbxref_id"':
                        $stmt->bindValue($identifier, $this->pub_dbxref_id, PDO::PARAM_INT);
                        break;
                    case '"pub_id"':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PubDbxrefPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PubDbxrefPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PubDbxref'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PubDbxref'][$this->getPrimaryKey()] = true;
        $keys = PubDbxrefPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getPubDbxrefId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setPubDbxrefId($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PubDbxrefPeer::PUB_DBXREF_ID)) $criteria->add(PubDbxrefPeer::PUB_DBXREF_ID, $this->pub_dbxref_id);
        if ($this->isColumnModified(PubDbxrefPeer::PUB_ID)) $criteria->add(PubDbxrefPeer::PUB_ID, $this->pub_id);
        if ($this->isColumnModified(PubDbxrefPeer::DBXREF_ID)) $criteria->add(PubDbxrefPeer::DBXREF_ID, $this->dbxref_id);
        if ($this->isColumnModified(PubDbxrefPeer::IS_CURRENT)) $criteria->add(PubDbxrefPeer::IS_CURRENT, $this->is_current);
    ...
    {
        $criteria = new Criteria(PubDbxrefPeer::DATABASE_NAME);
        $criteria->add(PubDbxrefPeer::PUB_DBXREF_ID, $this->pub_dbxref_id);
    ...
    /**
     * Generic method to set the primary key (pub_dbxref_id column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getPubDbxrefId();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of PubDbxref (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setPubDbxrefId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PubDbxref Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PubDbxrefPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PubDbxrefPeer();
        }
    ...
    public function getDbxref(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDbxref === null && ($this->dbxref_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDbxref->addPubDbxrefs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PubDbxrefPeer::DEFAULT_STRING_FORMAT);
    }
