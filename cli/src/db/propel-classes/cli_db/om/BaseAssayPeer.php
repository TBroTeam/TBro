    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Assay) to the collection in $obj2 (Contact)
                $obj2->addAssay($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Assay) to the collection in $obj3 (Protocol)
                $obj3->addAssay($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptContact(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = AssayPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Assay) to the collection in $obj2 (Protocol)
                $obj2->addAssay($obj1);
