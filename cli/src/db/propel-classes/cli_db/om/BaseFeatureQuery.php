 ...
 *
 * @method FeatureQuery leftJoinAnalysisfeature($relationAlias = null) Adds a LEFT JOIN clause to the query using the Analysisfeature relation
 * @method FeatureQuery rightJoinAnalysisfeature($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Analysisfeature relation
 * @method FeatureQuery innerJoinAnalysisfeature($relationAlias = null) Adds a INNER JOIN clause to the query using the Analysisfeature relation
 *
 * @method FeatureQuery leftJoinElement($relationAlias = null) Adds a LEFT JOIN clause to the query using the Element relation
 * @method FeatureQuery rightJoinElement($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Element relation
 * @method FeatureQuery innerJoinElement($relationAlias = null) Adds a INNER JOIN clause to the query using the Element relation
 *
 ...
 *
 * @method FeatureQuery leftJoinFeatureRelationshipRelatedByObjectId($relationAlias = null) Adds a LEFT JOIN clause to the query using the FeatureRelationshipRelatedByObjectId relation
 * @method FeatureQuery rightJoinFeatureRelationshipRelatedByObjectId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the FeatureRelationshipRelatedByObjectId relation
 * @method FeatureQuery innerJoinFeatureRelationshipRelatedByObjectId($relationAlias = null) Adds a INNER JOIN clause to the query using the FeatureRelationshipRelatedByObjectId relation
 *
 * @method FeatureQuery leftJoinFeatureRelationshipRelatedBySubjectId($relationAlias = null) Adds a LEFT JOIN clause to the query using the FeatureRelationshipRelatedBySubjectId relation
 * @method FeatureQuery rightJoinFeatureRelationshipRelatedBySubjectId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the FeatureRelationshipRelatedBySubjectId relation
 * @method FeatureQuery innerJoinFeatureRelationshipRelatedBySubjectId($relationAlias = null) Adds a INNER JOIN clause to the query using the FeatureRelationshipRelatedBySubjectId relation
 *
 ...
 *
 * @method FeatureQuery leftJoinFeaturelocRelatedByFeatureId($relationAlias = null) Adds a LEFT JOIN clause to the query using the FeaturelocRelatedByFeatureId relation
 * @method FeatureQuery rightJoinFeaturelocRelatedByFeatureId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the FeaturelocRelatedByFeatureId relation
 * @method FeatureQuery innerJoinFeaturelocRelatedByFeatureId($relationAlias = null) Adds a INNER JOIN clause to the query using the FeaturelocRelatedByFeatureId relation
 *
 * @method FeatureQuery leftJoinFeaturelocRelatedBySrcfeatureId($relationAlias = null) Adds a LEFT JOIN clause to the query using the FeaturelocRelatedBySrcfeatureId relation
 * @method FeatureQuery rightJoinFeaturelocRelatedBySrcfeatureId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the FeaturelocRelatedBySrcfeatureId relation
 * @method FeatureQuery innerJoinFeaturelocRelatedBySrcfeatureId($relationAlias = null) Adds a INNER JOIN clause to the query using the FeaturelocRelatedBySrcfeatureId relation
 *
 * @method FeatureQuery leftJoinFeatureprop($relationAlias = null) Adds a LEFT JOIN clause to the query using the Featureprop relation
 * @method FeatureQuery rightJoinFeatureprop($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Featureprop relation
 * @method FeatureQuery innerJoinFeatureprop($relationAlias = null) Adds a INNER JOIN clause to the query using the Featureprop relation
 *
 * @method FeatureQuery leftJoinQuantificationresult($relationAlias = null) Adds a LEFT JOIN clause to the query using the Quantificationresult relation
 * @method FeatureQuery rightJoinQuantificationresult($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Quantificationresult relation
 * @method FeatureQuery innerJoinQuantificationresult($relationAlias = null) Adds a INNER JOIN clause to the query using the Quantificationresult relation
 *
 * @method FeatureQuery leftJoinStudypropFeature($relationAlias = null) Adds a LEFT JOIN clause to the query using the StudypropFeature relation
 * @method FeatureQuery rightJoinStudypropFeature($relationAlias = null) Adds a RIGHT JOIN clause to the query using the StudypropFeature relation
 * @method FeatureQuery innerJoinStudypropFeature($relationAlias = null) Adds a INNER JOIN clause to the query using the StudypropFeature relation
 *
...
abstract class BaseFeatureQuery extends ModelCriteria
{
    ...
    public function filterByAnalysisfeature($analysisfeature, $comparison = null)
    {
        if ($analysisfeature instanceof Analysisfeature) {
            return $this
                ->addUsingAlias(FeaturePeer::FEATURE_ID, $analysisfeature->getFeatureId(), $comparison);
    ...
    public function filterByElement($element, $comparison = null)
    {
        if ($element instanceof Element) {
            return $this
                ->addUsingAlias(FeaturePeer::FEATURE_ID, $element->getFeatureId(), $comparison);
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByFeatureRelationshipRelatedByObjectId($featureRelationship, $comparison = null)
    {
        if ($featureRelationship instanceof FeatureRelationship) {
            return $this
                ->addUsingAlias(FeaturePeer::FEATURE_ID, $featureRelationship->getObjectId(), $comparison);
        } elseif ($featureRelationship instanceof PropelObjectCollection) {
            return $this
                ->useFeatureRelationshipRelatedByObjectIdQuery()
                ->filterByPrimaryKeys($featureRelationship->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByFeatureRelationshipRelatedByObjectId() only accepts arguments of type FeatureRelationship or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the FeatureRelationshipRelatedByObjectId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return FeatureQuery The current query, for fluid interface
     */
    public function joinFeatureRelationshipRelatedByObjectId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('FeatureRelationshipRelatedByObjectId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'FeatureRelationshipRelatedByObjectId');
        }
    ...
    /**
     * Use the FeatureRelationshipRelatedByObjectId relation FeatureRelationship object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useFeatureRelationshipRelatedByObjectIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinFeatureRelationshipRelatedByObjectId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'FeatureRelationshipRelatedByObjectId', '\cli_db\propel\FeatureRelationshipQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByFeatureRelationshipRelatedBySubjectId($featureRelationship, $comparison = null)
    {
        if ($featureRelationship instanceof FeatureRelationship) {
            return $this
                ->addUsingAlias(FeaturePeer::FEATURE_ID, $featureRelationship->getSubjectId(), $comparison);
        } elseif ($featureRelationship instanceof PropelObjectCollection) {
            return $this
                ->useFeatureRelationshipRelatedBySubjectIdQuery()
                ->filterByPrimaryKeys($featureRelationship->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByFeatureRelationshipRelatedBySubjectId() only accepts arguments of type FeatureRelationship or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the FeatureRelationshipRelatedBySubjectId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return FeatureQuery The current query, for fluid interface
     */
    public function joinFeatureRelationshipRelatedBySubjectId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('FeatureRelationshipRelatedBySubjectId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'FeatureRelationshipRelatedBySubjectId');
        }
    ...
    /**
     * Use the FeatureRelationshipRelatedBySubjectId relation FeatureRelationship object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   \cli_db\propel\FeatureRelationshipQuery A secondary query class using the current class as primary query
     */
    public function useFeatureRelationshipRelatedBySubjectIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinFeatureRelationshipRelatedBySubjectId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'FeatureRelationshipRelatedBySubjectId', '\cli_db\propel\FeatureRelationshipQuery');
    }
     ...
     *
     * @param   Featureloc|PropelObjectCollection $featureloc  the related object to use as filter
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return                 FeatureQuery The current query, for fluid interface
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByFeaturelocRelatedByFeatureId($featureloc, $comparison = null)
    {
        if ($featureloc instanceof Featureloc) {
            return $this
                ->addUsingAlias(FeaturePeer::FEATURE_ID, $featureloc->getFeatureId(), $comparison);
        } elseif ($featureloc instanceof PropelObjectCollection) {
            return $this
                ->useFeaturelocRelatedByFeatureIdQuery()
                ->filterByPrimaryKeys($featureloc->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByFeaturelocRelatedByFeatureId() only accepts arguments of type Featureloc or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the FeaturelocRelatedByFeatureId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return FeatureQuery The current query, for fluid interface
     */
    public function joinFeaturelocRelatedByFeatureId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('FeaturelocRelatedByFeatureId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'FeaturelocRelatedByFeatureId');
        }
    ...
    /**
     * Use the FeaturelocRelatedByFeatureId relation Featureloc object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useFeaturelocRelatedByFeatureIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinFeaturelocRelatedByFeatureId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'FeaturelocRelatedByFeatureId', '\cli_db\propel\FeaturelocQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByFeaturelocRelatedBySrcfeatureId($featureloc, $comparison = null)
    {
        if ($featureloc instanceof Featureloc) {
            return $this
                ->addUsingAlias(FeaturePeer::FEATURE_ID, $featureloc->getSrcfeatureId(), $comparison);
        } elseif ($featureloc instanceof PropelObjectCollection) {
            return $this
                ->useFeaturelocRelatedBySrcfeatureIdQuery()
                ->filterByPrimaryKeys($featureloc->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByFeaturelocRelatedBySrcfeatureId() only accepts arguments of type Featureloc or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the FeaturelocRelatedBySrcfeatureId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return FeatureQuery The current query, for fluid interface
     */
    public function joinFeaturelocRelatedBySrcfeatureId($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('FeaturelocRelatedBySrcfeatureId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'FeaturelocRelatedBySrcfeatureId');
        }
    ...
    /**
     * Use the FeaturelocRelatedBySrcfeatureId relation Featureloc object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   \cli_db\propel\FeaturelocQuery A secondary query class using the current class as primary query
     */
    public function useFeaturelocRelatedBySrcfeatureIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinFeaturelocRelatedBySrcfeatureId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'FeaturelocRelatedBySrcfeatureId', '\cli_db\propel\FeaturelocQuery');
    }
    ...
    public function filterByFeatureprop($featureprop, $comparison = null)
    {
        if ($featureprop instanceof Featureprop) {
            return $this
                ->addUsingAlias(FeaturePeer::FEATURE_ID, $featureprop->getFeatureId(), $comparison);
    ...
    public function filterByQuantificationresult($quantificationresult, $comparison = null)
    {
        if ($quantificationresult instanceof Quantificationresult) {
            return $this
                ->addUsingAlias(FeaturePeer::FEATURE_ID, $quantificationresult->getFeatureId(), $comparison);
    ...
    public function filterByStudypropFeature($studypropFeature, $comparison = null)
    {
        if ($studypropFeature instanceof StudypropFeature) {
            return $this
                ->addUsingAlias(FeaturePeer::FEATURE_ID, $studypropFeature->getFeatureId(), $comparison);
