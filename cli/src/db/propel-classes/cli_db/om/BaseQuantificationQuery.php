 ...
 *
 * @method QuantificationQuery leftJoinElementresult($relationAlias = null) Adds a LEFT JOIN clause to the query using the Elementresult relation
 * @method QuantificationQuery rightJoinElementresult($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Elementresult relation
 * @method QuantificationQuery innerJoinElementresult($relationAlias = null) Adds a INNER JOIN clause to the query using the Elementresult relation
 *
 * @method QuantificationQuery leftJoinQuantificationRelationshipRelatedByObjectId($relationAlias = null) Adds a LEFT JOIN clause to the query using the QuantificationRelationshipRelatedByObjectId relation
 * @method QuantificationQuery rightJoinQuantificationRelationshipRelatedByObjectId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the QuantificationRelationshipRelatedByObjectId relation
 * @method QuantificationQuery innerJoinQuantificationRelationshipRelatedByObjectId($relationAlias = null) Adds a INNER JOIN clause to the query using the QuantificationRelationshipRelatedByObjectId relation
 *
 * @method QuantificationQuery leftJoinQuantificationRelationshipRelatedBySubjectId($relationAlias = null) Adds a LEFT JOIN clause to the query using the QuantificationRelationshipRelatedBySubjectId relation
 * @method QuantificationQuery rightJoinQuantificationRelationshipRelatedBySubjectId($relationAlias = null) Adds a RIGHT JOIN clause to the query using the QuantificationRelationshipRelatedBySubjectId relation
 * @method QuantificationQuery innerJoinQuantificationRelationshipRelatedBySubjectId($relationAlias = null) Adds a INNER JOIN clause to the query using the QuantificationRelationshipRelatedBySubjectId relation
 *
 * @method QuantificationQuery leftJoinQuantificationprop($relationAlias = null) Adds a LEFT JOIN clause to the query using the Quantificationprop relation
 * @method QuantificationQuery rightJoinQuantificationprop($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Quantificationprop relation
 * @method QuantificationQuery innerJoinQuantificationprop($relationAlias = null) Adds a INNER JOIN clause to the query using the Quantificationprop relation
 *
 * @method QuantificationQuery leftJoinQuantificationresult($relationAlias = null) Adds a LEFT JOIN clause to the query using the Quantificationresult relation
 * @method QuantificationQuery rightJoinQuantificationresult($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Quantificationresult relation
 * @method QuantificationQuery innerJoinQuantificationresult($relationAlias = null) Adds a INNER JOIN clause to the query using the Quantificationresult relation
 *
...
abstract class BaseQuantificationQuery extends ModelCriteria
{
    ...
    public function filterByElementresult($elementresult, $comparison = null)
    {
        if ($elementresult instanceof Elementresult) {
            return $this
                ->addUsingAlias(QuantificationPeer::QUANTIFICATION_ID, $elementresult->getQuantificationId(), $comparison);
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByQuantificationRelationshipRelatedByObjectId($quantificationRelationship, $comparison = null)
    {
        if ($quantificationRelationship instanceof QuantificationRelationship) {
            return $this
                ->addUsingAlias(QuantificationPeer::QUANTIFICATION_ID, $quantificationRelationship->getObjectId(), $comparison);
        } elseif ($quantificationRelationship instanceof PropelObjectCollection) {
            return $this
                ->useQuantificationRelationshipRelatedByObjectIdQuery()
                ->filterByPrimaryKeys($quantificationRelationship->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByQuantificationRelationshipRelatedByObjectId() only accepts arguments of type QuantificationRelationship or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the QuantificationRelationshipRelatedByObjectId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return QuantificationQuery The current query, for fluid interface
     */
    public function joinQuantificationRelationshipRelatedByObjectId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('QuantificationRelationshipRelatedByObjectId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'QuantificationRelationshipRelatedByObjectId');
        }
    ...
    /**
     * Use the QuantificationRelationshipRelatedByObjectId relation QuantificationRelationship object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useQuantificationRelationshipRelatedByObjectIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinQuantificationRelationshipRelatedByObjectId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'QuantificationRelationshipRelatedByObjectId', '\cli_db\propel\QuantificationRelationshipQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByQuantificationRelationshipRelatedBySubjectId($quantificationRelationship, $comparison = null)
    {
        if ($quantificationRelationship instanceof QuantificationRelationship) {
            return $this
                ->addUsingAlias(QuantificationPeer::QUANTIFICATION_ID, $quantificationRelationship->getSubjectId(), $comparison);
        } elseif ($quantificationRelationship instanceof PropelObjectCollection) {
            return $this
                ->useQuantificationRelationshipRelatedBySubjectIdQuery()
                ->filterByPrimaryKeys($quantificationRelationship->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByQuantificationRelationshipRelatedBySubjectId() only accepts arguments of type QuantificationRelationship or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the QuantificationRelationshipRelatedBySubjectId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return QuantificationQuery The current query, for fluid interface
     */
    public function joinQuantificationRelationshipRelatedBySubjectId($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('QuantificationRelationshipRelatedBySubjectId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'QuantificationRelationshipRelatedBySubjectId');
        }
    ...
    /**
     * Use the QuantificationRelationshipRelatedBySubjectId relation QuantificationRelationship object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   \cli_db\propel\QuantificationRelationshipQuery A secondary query class using the current class as primary query
     */
    public function useQuantificationRelationshipRelatedBySubjectIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinQuantificationRelationshipRelatedBySubjectId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'QuantificationRelationshipRelatedBySubjectId', '\cli_db\propel\QuantificationRelationshipQuery');
    }
    ...
    public function filterByQuantificationprop($quantificationprop, $comparison = null)
    {
        if ($quantificationprop instanceof Quantificationprop) {
            return $this
                ->addUsingAlias(QuantificationPeer::QUANTIFICATION_ID, $quantificationprop->getQuantificationId(), $comparison);
    ...
    public function filterByQuantificationresult($quantificationresult, $comparison = null)
    {
        if ($quantificationresult instanceof Quantificationresult) {
            return $this
                ->addUsingAlias(QuantificationPeer::QUANTIFICATION_ID, $quantificationresult->getQuantificationId(), $comparison);
