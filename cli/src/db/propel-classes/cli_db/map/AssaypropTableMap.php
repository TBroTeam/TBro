...
/**
 * This class defines the structure of the 'assayprop' table.
 *
 *
 *
 ...
 */
class AssaypropTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cli_db.map.AssaypropTableMap';
    ...
    {
        // attributes
        $this->setName('assayprop');
        $this->setPhpName('Assayprop');
        $this->setClassname('cli_db\\propel\\Assayprop');
        $this->setPackage('cli_db');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('assayprop_assayprop_id_seq');
        // columns
        $this->addPrimaryKey('assayprop_id', 'AssaypropId', 'INTEGER', true, null, null);
