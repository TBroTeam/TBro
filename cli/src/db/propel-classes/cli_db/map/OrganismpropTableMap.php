...
/**
 * This class defines the structure of the 'organismprop' table.
 *
 *
 *
 ...
 */
class OrganismpropTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cli_db.map.OrganismpropTableMap';
    ...
    {
        // attributes
        $this->setName('organismprop');
        $this->setPhpName('Organismprop');
        $this->setClassname('cli_db\\propel\\Organismprop');
        $this->setPackage('cli_db');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('organismprop_organismprop_id_seq');
        // columns
        $this->addPrimaryKey('organismprop_id', 'OrganismpropId', 'INTEGER', true, null, null);
