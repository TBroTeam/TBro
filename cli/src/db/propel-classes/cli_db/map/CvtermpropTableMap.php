...
/**
 * This class defines the structure of the 'cvtermprop' table.
 *
 *
 *
 ...
 */
class CvtermpropTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cli_db.map.CvtermpropTableMap';
    ...
    {
        // attributes
        $this->setName('cvtermprop');
        $this->setPhpName('Cvtermprop');
        $this->setClassname('cli_db\\propel\\Cvtermprop');
        $this->setPackage('cli_db');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('cvtermprop_cvtermprop_id_seq');
        // columns
        $this->addPrimaryKey('cvtermprop_id', 'CvtermpropId', 'INTEGER', true, null, null);
