<?php /* Smarty version Smarty-3.1.13, created on 2013-04-15 19:55:50
         compiled from "/home/s202139/git/httpdocs/smarty/templates/cart.js" */ ?>
<?php /*%%SmartyHeaderCode:65033996851485f3c3f8c81-01919983%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4aca2fa309f2ed28acc7d5ef32c21765cc63ea77' => 
    array (
      0 => '/home/s202139/git/httpdocs/smarty/templates/cart.js',
      1 => 1366048541,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '65033996851485f3c3f8c81-01919983',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_51485f3c4724a3_60012631',
  'variables' => 
  array (
    'ServicePath' => 0,
    'AppPath' => 0,
...
<?php if ($_valid && !is_callable('content_51485f3c4724a3_60012631')) {function content_51485f3c4724a3_60012631($_smarty_tpl) {?>// In case we forget to take out console statements (and we will, because it is just too useful). IE becomes very unhappy when we forget. Let's not make IE unhappy
...
/graphs/'+$(this).parents('.cart-group').first().attr('data-group');
    });
...
cart.renameGroup = function(oldname, newname, options) {
    ...
    if (newname === "all" || !newname.match(<?php echo $_smarty_tpl->tpl_vars['regexCartName']->value;?>
)){
...
cart.buildCartItemDOM = function(item) {
    ...
    newEl.find('.cart-button-goto').click(function() {
        window.location = '<?php echo $_smarty_tpl->tpl_vars['AppPath']->value;?>
/isoform-details/byId/' + item.feature_id;
    });
